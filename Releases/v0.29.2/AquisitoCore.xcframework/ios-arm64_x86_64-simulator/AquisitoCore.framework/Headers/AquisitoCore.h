 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)signUpName:(NSString *)name email:(NSString *)email username:(NSString *)username phone:(NSString *)phone password:(NSString * _Nullable)password avatar:(NSString * _Nullable)avatar socialDriver:(NSString * _Nullable)socialDriver socialId:(NSString * _Nullable)socialId completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("signUp(name:email:username:phone:password:avatar:socialDriver:socialId:completionHandler:)")));
