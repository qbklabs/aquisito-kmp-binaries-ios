...
- (AquisitoCoreGetDistrictsUseCase *)getListDistrictsUseCase __attribute__((swift_name("getListDistrictsUseCase()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RatingRequest")))
@interface AquisitoCoreRatingRequest : AquisitoCoreBase
- (instancetype)initWithFood_rating:(int32_t)food_rating service_rating:(int32_t)service_rating ambience_rating:(int32_t)ambience_rating price_rating:(int32_t)price_rating comment:(NSString * _Nullable)comment __attribute__((swift_name("init(food_rating:service_rating:ambience_rating:price_rating:comment:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreRatingRequest *)doCopyFood_rating:(int32_t)food_rating service_rating:(int32_t)service_rating ambience_rating:(int32_t)ambience_rating price_rating:(int32_t)price_rating comment:(NSString * _Nullable)comment __attribute__((swift_name("doCopy(food_rating:service_rating:ambience_rating:price_rating:comment:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithId:(int32_t)id name:(NSString *)name ubigeo:(NSString *)ubigeo province:(AquisitoCoreProvinceDto *)province department:(AquisitoCoreDepartmentDto *)department __attribute__((swift_name("init(id:name:ubigeo:province:department:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreAvailableAreaDto *)doCopyId:(int32_t)id name:(NSString *)name ubigeo:(NSString *)ubigeo province:(AquisitoCoreProvinceDto *)province department:(AquisitoCoreDepartmentDto *)department __attribute__((swift_name("doCopy(id:name:ubigeo:province:department:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) AquisitoCoreDepartmentDto *department __attribute__((swift_name("department")));
...
@property (readonly) NSString * _Nullable description_ __attribute__((swift_name("description_")));
@property (readonly) AquisitoCoreDistrictDto *district __attribute__((swift_name("district")));
@property (readonly) NSArray<NSString *> * _Nullable gallery __attribute__((swift_name("gallery")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
...
@property (readonly) AquisitoCoreInt * _Nullable user_reaction_id __attribute__((swift_name("user_reaction_id")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)upsertRatingSlug:(NSString *)slug request:(AquisitoCoreRatingRequest *)request completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("upsertRating(slug:request:completionHandler:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AreaRepositoryImpl")))
@interface AquisitoCoreAreaRepositoryImpl : AquisitoCoreBase <AquisitoCoreAreaRepository>
- (instancetype)initWithApi:(AquisitoCoreAreaApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)initWithApi:(AquisitoCoreAuthApi *)api dataSource:(id<AquisitoCoreAuthLocalDataSource>)dataSource sessionManager:(id<AquisitoCoreSessionManager>)sessionManager __attribute__((swift_name("init(api:dataSource:sessionManager:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CartRepositoryImpl")))
@interface AquisitoCoreCartRepositoryImpl : AquisitoCoreBase <AquisitoCoreCartRepository>
- (instancetype)initWithApi:(AquisitoCoreCartApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)findDistrictByAreaAreaId:(int32_t)areaId areaName:(NSString *)areaName completionHandler:(void (^)(AquisitoCoreDistrict * _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("findDistrictByArea(areaId:areaName:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)findDistrictByNameName:(NSString *)name completionHandler:(void (^)(AquisitoCoreDistrict * _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("findDistrictByName(name:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)upsertRatingSlug:(NSString *)slug rating:(AquisitoCoreRating *)rating completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("upsertRating(slug:rating:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RatingPlaceRepositoryImpl")))
@interface AquisitoCoreRatingPlaceRepositoryImpl : AquisitoCoreBase <AquisitoCoreRatingPlaceRepository>
- (instancetype)initWithApi:(AquisitoCoreRatingPlaceApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)initWithId:(int32_t)id name:(NSString *)name ubigeo:(NSString *)ubigeo province:(AquisitoCoreProvince *)province department:(AquisitoCoreDepartment *)department __attribute__((swift_name("init(id:name:ubigeo:province:department:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreAvailableArea *)doCopyId:(int32_t)id name:(NSString *)name ubigeo:(NSString *)ubigeo province:(AquisitoCoreProvince *)province department:(AquisitoCoreDepartment *)department __attribute__((swift_name("doCopy(id:name:ubigeo:province:department:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithId:(int32_t)id name:(NSString *)name city:(AquisitoCoreDepartment *)city areas:(NSArray<AquisitoCoreDistrict_ *> *)areas __attribute__((swift_name("init(id:name:city:areas:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreGroupedArea *)doCopyId:(int32_t)id name:(NSString *)name city:(AquisitoCoreDepartment *)city areas:(NSArray<AquisitoCoreDistrict_ *> *)areas __attribute__((swift_name("doCopy(id:name:city:areas:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<AquisitoCoreDistrict_ *> *areas __attribute__((swift_name("areas")));
...
- (instancetype)initWithId:(int32_t)id foodRating:(int32_t)foodRating serviceRating:(int32_t)serviceRating ambienceRating:(int32_t)ambienceRating priceRating:(int32_t)priceRating overallScore:(NSString *)overallScore comment:(NSString * _Nullable)comment isFeatured:(BOOL)isFeatured likesCount:(int32_t)likesCount dislikesCount:(int32_t)dislikesCount user:(AquisitoCoreUser * _Nullable)user userReactionId:(AquisitoCoreInt * _Nullable)userReactionId userReaction:(NSString * _Nullable)userReaction createdAt:(NSString * _Nullable)createdAt updatedAt:(NSString * _Nullable)updatedAt __attribute__((swift_name("init(id:foodRating:serviceRating:ambienceRating:priceRating:overallScore:comment:isFeatured:likesCount:dislikesCount:user:userReactionId:userReaction:createdAt:updatedAt:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreRating *)doCopyId:(int32_t)id foodRating:(int32_t)foodRating serviceRating:(int32_t)serviceRating ambienceRating:(int32_t)ambienceRating priceRating:(int32_t)priceRating overallScore:(NSString *)overallScore comment:(NSString * _Nullable)comment isFeatured:(BOOL)isFeatured likesCount:(int32_t)likesCount dislikesCount:(int32_t)dislikesCount user:(AquisitoCoreUser * _Nullable)user userReactionId:(AquisitoCoreInt * _Nullable)userReactionId userReaction:(NSString * _Nullable)userReaction createdAt:(NSString * _Nullable)createdAt updatedAt:(NSString * _Nullable)updatedAt __attribute__((swift_name("doCopy(id:foodRating:serviceRating:ambienceRating:priceRating:overallScore:comment:isFeatured:likesCount:dislikesCount:user:userReactionId:userReaction:createdAt:updatedAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) AquisitoCoreInt * _Nullable userReactionId __attribute__((swift_name("userReactionId")));
@end
...
- (instancetype)initWithRepository:(id<AquisitoCoreLocationRepository>)repository clock:(id<AquisitoCoreClock>)clock __attribute__((swift_name("init(repository:clock:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)initWithLocationClient:(id<AquisitoCoreLocationClient>)locationClient repository:(id<AquisitoCoreLocationRepository>)repository getAvailableAreaByLocationUseCase:(AquisitoCoreGetAvailableAreaByLocationUseCase *)getAvailableAreaByLocationUseCase setLocationOnContextUseCase:(AquisitoCoreSetLocationOnContextUseCase *)setLocationOnContextUseCase matchRadiusMeters:(double)matchRadiusMeters __attribute__((swift_name("init(locationClient:repository:getAvailableAreaByLocationUseCase:setLocationOnContextUseCase:matchRadiusMeters:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetDistrictsUseCase")))
@interface AquisitoCoreGetDistrictsUseCase : AquisitoCoreBase
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokeSlug:(NSString *)slug rating:(AquisitoCoreRating *)rating completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(slug:rating:completionHandler:)")));
@end
...
+ (AquisitoCoreDistrict * _Nullable)findDistrictByAreaIdOrNameAreaId:(int32_t)areaId areaName:(NSString *)areaName __attribute__((swift_name("findDistrictByAreaIdOrName(areaId:areaName:)")));
+ (AquisitoCoreDistrict * _Nullable)findDistrictByIdId:(NSString *)id __attribute__((swift_name("findDistrictById(id:)")));
+ (AquisitoCoreDistrict * _Nullable)findDistrictByNameName:(NSString *)name __attribute__((swift_name("findDistrictByName(name:)")));
