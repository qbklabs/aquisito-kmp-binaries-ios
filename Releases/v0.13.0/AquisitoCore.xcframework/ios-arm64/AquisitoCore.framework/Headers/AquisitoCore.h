...
- (instancetype)initWithId:(int32_t)id foodRating:(int32_t)foodRating serviceRating:(int32_t)serviceRating ambienceRating:(int32_t)ambienceRating priceRating:(int32_t)priceRating overallScore:(NSString *)overallScore comment:(NSString * _Nullable)comment isFeatured:(BOOL)isFeatured likesCount:(int32_t)likesCount dislikesCount:(int32_t)dislikesCount user:(AquisitoCoreUser * _Nullable)user userReaction:(NSString * _Nullable)userReaction createdAt:(NSString * _Nullable)createdAt updatedAt:(NSString * _Nullable)updatedAt __attribute__((swift_name("init(id:foodRating:serviceRating:ambienceRating:priceRating:overallScore:comment:isFeatured:likesCount:dislikesCount:user:userReaction:createdAt:updatedAt:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreRating *)doCopyId:(int32_t)id foodRating:(int32_t)foodRating serviceRating:(int32_t)serviceRating ambienceRating:(int32_t)ambienceRating priceRating:(int32_t)priceRating overallScore:(NSString *)overallScore comment:(NSString * _Nullable)comment isFeatured:(BOOL)isFeatured likesCount:(int32_t)likesCount dislikesCount:(int32_t)dislikesCount user:(AquisitoCoreUser * _Nullable)user userReaction:(NSString * _Nullable)userReaction createdAt:(NSString * _Nullable)createdAt updatedAt:(NSString * _Nullable)updatedAt __attribute__((swift_name("doCopy(id:foodRating:serviceRating:ambienceRating:priceRating:overallScore:comment:isFeatured:likesCount:dislikesCount:user:userReaction:createdAt:updatedAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
