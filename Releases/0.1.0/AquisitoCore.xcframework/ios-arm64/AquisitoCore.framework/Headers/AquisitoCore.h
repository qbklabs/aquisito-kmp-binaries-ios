...
- (instancetype)initWithId:(AquisitoCoreInt * _Nullable)id name:(NSString * _Nullable)name ubigeo:(NSString * _Nullable)ubigeo __attribute__((swift_name("init(id:name:ubigeo:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) AquisitoCoreDistrictDtoCompanion *companion __attribute__((swift_name("companion")));
- (AquisitoCoreDistrictDto *)doCopyId:(AquisitoCoreInt * _Nullable)id name:(NSString * _Nullable)name ubigeo:(NSString * _Nullable)ubigeo __attribute__((swift_name("doCopy(id:name:ubigeo:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) AquisitoCoreInt * _Nullable id __attribute__((swift_name("id")));
...
- (instancetype)initWithId:(AquisitoCoreInt * _Nullable)id name:(NSString * _Nullable)name featured:(AquisitoCoreBoolean * _Nullable)featured description:(NSString * _Nullable)description price:(AquisitoCoreDouble * _Nullable)price __attribute__((swift_name("init(id:name:featured:description:price:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) AquisitoCoreMenuEntryDtoCompanion *companion __attribute__((swift_name("companion")));
- (AquisitoCoreMenuEntryDto *)doCopyId:(AquisitoCoreInt * _Nullable)id name:(NSString * _Nullable)name featured:(AquisitoCoreBoolean * _Nullable)featured description:(NSString * _Nullable)description price:(AquisitoCoreDouble * _Nullable)price __attribute__((swift_name("doCopy(id:name:featured:description:price:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) AquisitoCoreInt * _Nullable id __attribute__((swift_name("id")));
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
@property (readonly) AquisitoCoreDouble * _Nullable price __attribute__((swift_name("price")));
@end
...
- (AquisitoCorePlaceDetailDto *)doCopyId:(int32_t)id name:(NSString *)name slug:(NSString *)slug description:(NSString * _Nullable)description address:(NSString * _Nullable)address latitude:(NSString * _Nullable)latitude longitude:(NSString * _Nullable)longitude price_range:(NSString * _Nullable)price_range schedule:(NSArray<AquisitoCoreScheduleDto *> * _Nullable)schedule logo:(NSString * _Nullable)logo gallery:(NSArray<NSString *> * _Nullable)gallery district:(AquisitoCoreDistrictDto * _Nullable)district province:(AquisitoCoreProvinceDto * _Nullable)province department:(AquisitoCoreDepartmentDto * _Nullable)department cuisines:(NSArray<AquisitoCoreCuisineDto *> * _Nullable)cuisines amenities:(NSArray<AquisitoCoreAmenityDto *> * _Nullable)amenities phones:(NSArray<AquisitoCorePhoneDto *> * _Nullable)phones featured:(AquisitoCoreBoolean * _Nullable)featured links:(NSArray<AquisitoCoreLinkDto *> * _Nullable)links thumbnail_url:(NSString * _Nullable)thumbnail_url created_at:(NSString * _Nullable)created_at updated_at:(NSString * _Nullable)updated_at mentions:(NSArray<AquisitoCoreMentionDto *> * _Nullable)mentions restaurantCarts:(NSArray<AquisitoCoreRestaurantCartDto *> * _Nullable)restaurantCarts tags:(NSArray<AquisitoCoreTagDto *> * _Nullable)tags categories:(NSArray<AquisitoCoreCategoryDto *> * _Nullable)categories __attribute__((swift_name("doCopy(id:name:slug:description:address:latitude:longitude:price_range:schedule:logo:gallery:district:province:department:cuisines:amenities:phones:featured:links:thumbnail_url:created_at:updated_at:mentions:restaurantCarts:tags:categories:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (AquisitoCoreProvinceDto *)doCopyId:(AquisitoCoreInt * _Nullable)id name:(NSString * _Nullable)name __attribute__((swift_name("doCopy(id:name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) AquisitoCoreInt * _Nullable id __attribute__((swift_name("id")));
...
- (instancetype)initWithId:(AquisitoCoreInt * _Nullable)id name:(NSString * _Nullable)name place:(AquisitoCorePlaceReferenceDto * _Nullable)place link:(AquisitoCoreLinkDto * _Nullable)link menuEntries:(NSArray<AquisitoCoreMenuEntryDto *> * _Nullable)menuEntries __attribute__((swift_name("init(id:name:place:link:menuEntries:)"))) __attribute__((objc_designated_initializer));
...
- (AquisitoCoreRestaurantCartDto *)doCopyId:(AquisitoCoreInt * _Nullable)id name:(NSString * _Nullable)name place:(AquisitoCorePlaceReferenceDto * _Nullable)place link:(AquisitoCoreLinkDto * _Nullable)link menuEntries:(NSArray<AquisitoCoreMenuEntryDto *> * _Nullable)menuEntries __attribute__((swift_name("doCopy(id:name:place:link:menuEntries:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) AquisitoCoreInt * _Nullable id __attribute__((swift_name("id")));
...
- (AquisitoCoreDistrict *)doCopyId:(int32_t)id name:(NSString *)name ubigeo:(NSString *)ubigeo __attribute__((swift_name("doCopy(id:name:ubigeo:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
...
- (instancetype)initWithId:(int32_t)id name:(NSString *)name placeId:(AquisitoCoreInt * _Nullable)placeId link:(AquisitoCoreLink * _Nullable)link menuEntries:(NSArray<AquisitoCoreMenuEntry *> *)menuEntries __attribute__((swift_name("init(id:name:placeId:link:menuEntries:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreRestaurantCart *)doCopyId:(int32_t)id name:(NSString *)name placeId:(AquisitoCoreInt * _Nullable)placeId link:(AquisitoCoreLink * _Nullable)link menuEntries:(NSArray<AquisitoCoreMenuEntry *> *)menuEntries __attribute__((swift_name("doCopy(id:name:placeId:link:menuEntries:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
