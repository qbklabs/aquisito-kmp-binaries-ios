 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokeWithCompletionHandler:(void (^)(AquisitoCoreUseCaseResult<AquisitoCoreDistrict *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(completionHandler:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokeDistrictId:(NSString *)districtId completionHandler:(void (^)(AquisitoCoreUseCaseResult<AquisitoCoreDistrict *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(districtId:completionHandler:)")));
@end
...
@interface AquisitoCoreUseCaseResult<__covariant T> : AquisitoCoreBase
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UseCaseResultEmpty")))
@interface AquisitoCoreUseCaseResultEmpty : AquisitoCoreUseCaseResult<AquisitoCoreKotlinNothing *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)empty __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) AquisitoCoreUseCaseResultEmpty *shared __attribute__((swift_name("shared")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UseCaseResultError")))
@interface AquisitoCoreUseCaseResultError : AquisitoCoreUseCaseResult<AquisitoCoreKotlinNothing *>
- (instancetype)initWithError:(AquisitoCoreLocationError *)error __attribute__((swift_name("init(error:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreUseCaseResultError *)doCopyError:(AquisitoCoreLocationError *)error __attribute__((swift_name("doCopy(error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) AquisitoCoreLocationError *error __attribute__((swift_name("error")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UseCaseResultSuccess")))
@interface AquisitoCoreUseCaseResultSuccess<T> : AquisitoCoreUseCaseResult<T>
...
- (AquisitoCoreUseCaseResultSuccess<T> *)doCopyValue:(T _Nullable)value __attribute__((swift_name("doCopy(value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
