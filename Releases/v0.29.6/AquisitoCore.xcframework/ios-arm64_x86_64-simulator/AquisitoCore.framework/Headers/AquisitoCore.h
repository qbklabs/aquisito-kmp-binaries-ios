...
@class NSString, NSSet<ObjectType>, NSObject, NSNumber, NSMutableSet<ObjectType>, NSMutableDictionary<KeyType, ObjectType>, NSMutableArray<ObjectType>, NSError, NSDictionary<KeyType, ObjectType>, NSArray<ObjectType>, AquisitoCore__SkieTypeExportsKt, AquisitoCore__SkieSuspendWrappersKt, AquisitoCoreVerifyCodeUseCase, AquisitoCoreVerifyCodeRequestDtoCompanion, AquisitoCoreVerifyCodeRequestDto, AquisitoCoreUserModuleKt, AquisitoCoreUserDtoCompanion, AquisitoCoreUserDto, AquisitoCoreUserCompanion, AquisitoCoreUser, AquisitoCoreUseCaseProvider, AquisitoCoreUpsertRatingUseCase, AquisitoCoreUpdateUserProfileUseCase, AquisitoCoreUpdateUserProfileRequestDtoCompanion, AquisitoCoreUpdateUserProfileRequestDto, AquisitoCoreUpdatePasswordUseCase, AquisitoCoreUpdatePasswordRequestDtoCompanion, AquisitoCoreUpdatePasswordRequestDto, AquisitoCoreUShort, AquisitoCoreULong, AquisitoCoreUInt, AquisitoCoreUByte, AquisitoCoreTagDtoCompanion, AquisitoCoreTagDto, AquisitoCoreTag, AquisitoCoreSystemClock, AquisitoCoreSuccess<T>, AquisitoCoreStubLocationClient, AquisitoCoreStately_concurrencyThreadLocalRef<T>, AquisitoCoreSocialLoginUseCase, AquisitoCoreSocialLoginResult, AquisitoCoreSocialLoginResponseDtoCompanion, AquisitoCoreSocialLoginResponseDto, AquisitoCoreSocialLoginRequestDtoCompanion, AquisitoCoreSocialLoginRequestDto, AquisitoCoreSocialLoginDataDtoCompanion, AquisitoCoreSocialLoginDataDto, AquisitoCoreSkie_SuspendResultSuccess, AquisitoCoreSkie_SuspendResultError, AquisitoCoreSkie_SuspendResultCanceled, AquisitoCoreSkie_SuspendResult, AquisitoCoreSkie_SuspendHandler, AquisitoCoreSkie_CancellationHandler, AquisitoCoreSkieKotlinStateFlow<T>, AquisitoCoreSkieKotlinSharedFlow<T>, AquisitoCoreSkieKotlinOptionalStateFlow<T>, AquisitoCoreSkieKotlinOptionalSharedFlow<T>, AquisitoCoreSkieKotlinOptionalMutableStateFlow<T>, AquisitoCoreSkieKotlinOptionalMutableSharedFlow<T>, AquisitoCoreSkieKotlinOptionalFlow<T>, AquisitoCoreSkieKotlinMutableStateFlow<T>, AquisitoCoreSkieKotlinMutableSharedFlow<T>, AquisitoCoreSkieKotlinFlow<T>, AquisitoCoreSkieColdFlowIterator<E>, AquisitoCoreSimplePromotionDtoCompanion, AquisitoCoreSimplePromotionDto, AquisitoCoreSimplePromotion, AquisitoCoreSignUpUseCase, AquisitoCoreSignUpResult, AquisitoCoreSignUpResponseDtoCompanion, AquisitoCoreSignUpResponseDto, AquisitoCoreSignUpRequestDtoCompanion, AquisitoCoreSignUpRequestDto, AquisitoCoreSignUpDataDtoCompanion, AquisitoCoreSignUpDataDto, AquisitoCoreShort, AquisitoCoreSetLocationOnContextUseCase, AquisitoCoreSessionManagerImpl, AquisitoCoreScheduleDtoCompanion, AquisitoCoreScheduleDto, AquisitoCoreSchedule, AquisitoCoreRoom_runtimeRoomOpenDelegateValidationResult, AquisitoCoreRoom_runtimeRoomOpenDelegate, AquisitoCoreRoom_runtimeRoomDatabase, AquisitoCoreRoom_runtimeMigration, AquisitoCoreRoom_runtimeInvalidationTracker, AquisitoCoreRestaurantCartDtoCompanion, AquisitoCoreRestaurantCartDto, AquisitoCoreRestaurantCart, AquisitoCoreResetPasswordUseCase, AquisitoCoreResetPasswordRequestDtoCompanion, AquisitoCoreResetPasswordRequestDto, AquisitoCoreReservationDtoCompanion, AquisitoCoreReservationDto, AquisitoCoreRemoveReactionUseCase, AquisitoCoreRemovePlaceFromCollectionUseCase, AquisitoCoreRemovePlaceFromCollectionResponseDtoCompanion, AquisitoCoreRemovePlaceFromCollectionResponseDto, AquisitoCoreRemoveCollectionUseCase, AquisitoCoreRemoveCollectionResponseDtoCompanion, AquisitoCoreRemoveCollectionResponseDto, AquisitoCoreRedeemPromotionUseCase, AquisitoCoreReactionType, AquisitoCoreReactRatingUseCase, AquisitoCoreRatingStatusCompanion, AquisitoCoreRatingStatus, AquisitoCoreRatingPlaceModuleKt, AquisitoCoreRatingPlaceApi, AquisitoCoreRatingDtoCompanion, AquisitoCoreRatingDto, AquisitoCoreRating, AquisitoCoreProvinceDtoCompanion, AquisitoCoreProvinceDto, AquisitoCoreProvinceCompanion, AquisitoCoreProvince, AquisitoCorePromotionRepositoryImpl, AquisitoCorePromotionRedemptionDtoCompanion, AquisitoCorePromotionRedemptionDto, AquisitoCorePromotionRedemption, AquisitoCorePromotionModuleKt, AquisitoCorePromotionGalleryImageDtoCompanion, AquisitoCorePromotionGalleryImageDto, AquisitoCorePromotionGalleryImage, AquisitoCorePromotionDtoCompanion, AquisitoCorePromotionDto, AquisitoCorePromotionApi, AquisitoCorePromotion, AquisitoCorePlatform_iosKt, AquisitoCorePlatformKt, AquisitoCorePlatformEngine, AquisitoCorePlatformContext, AquisitoCorePlaceStatus, AquisitoCorePlaceReferenceDtoCompanion, AquisitoCorePlaceReferenceDto, AquisitoCorePlaceModuleKt, AquisitoCorePlaceDtoCompanion, AquisitoCorePlaceDto, AquisitoCorePlaceDetailDtoCompanion, AquisitoCorePlaceDetailDto, AquisitoCorePlaceApi, AquisitoCorePlace, AquisitoCorePhoneDtoCompanion, AquisitoCorePhoneDto, AquisitoCorePhone, AquisitoCoreNumber, AquisitoCoreNetworkModuleKt, AquisitoCoreNetworkConfig, AquisitoCoreMutableSet<ObjectType>, AquisitoCoreMutableDictionary<KeyType, ObjectType>, AquisitoCoreMenuEntryDtoCompanion, AquisitoCoreMenuEntryDto, AquisitoCoreMenuEntry, AquisitoCoreMentionDtoCompanion, AquisitoCoreMentionDto, AquisitoCoreMention, AquisitoCoreMarkOnboardingCompletedUseCase, AquisitoCoreLong, AquisitoCoreLogoutUseCase, AquisitoCoreLogoutResult, AquisitoCoreLogoutResponseDtoCompanion, AquisitoCoreLogoutResponseDto, AquisitoCoreLoginUseCase, AquisitoCoreLoginResult, AquisitoCoreLoginResponseDtoCompanion, AquisitoCoreLoginResponseDto, AquisitoCoreLoginRequestDtoCompanion, AquisitoCoreLoginRequestDto, AquisitoCoreLoginDataDtoCompanion, AquisitoCoreLoginDataDto, AquisitoCoreLocationStorageImpl, AquisitoCoreLocationState, AquisitoCoreLocationRepositoryStoredLocationResultValid, AquisitoCoreLocationRepositoryStoredLocationResultMissing, AquisitoCoreLocationRepositoryStoredLocationResult, AquisitoCoreLocationRepositoryImpl, AquisitoCoreLocationModuleKt, AquisitoCoreLocationEventDistrictSet, AquisitoCoreLocationEventDistrictCleared, AquisitoCoreLocationEventAllCleared, AquisitoCoreLocationEvent, AquisitoCoreLocationErrorUnknown, AquisitoCoreLocationErrorServicesDisabled, AquisitoCoreLocationErrorPermissionDenied, AquisitoCoreLocationErrorDistrictNotFound, AquisitoCoreLocationError, AquisitoCoreLocationContext, AquisitoCoreLocationConstantsKt, AquisitoCoreLocationClientResultUnknown, AquisitoCoreLocationClientResultSuccess, AquisitoCoreLocationClientResultServicesDisabled, AquisitoCoreLocationClientResultPermissionDenied, AquisitoCoreLocationClientResult, AquisitoCoreListResponseCompanion, AquisitoCoreListResponse<T>, AquisitoCoreListPlacePromotionsUseCase, AquisitoCoreLinkDtoCompanion, AquisitoCoreLinkDto, AquisitoCoreLink, AquisitoCoreLatLongRequestCompanion, AquisitoCoreLatLongRequest, AquisitoCoreKtor_utilsWeekDayCompanion, AquisitoCoreKtor_utilsWeekDay, AquisitoCoreKtor_utilsTypeInfo, AquisitoCoreKtor_utilsStringValuesBuilderImpl, AquisitoCoreKtor_utilsPipelinePhase, AquisitoCoreKtor_utilsPipeline<TSubject, TContext>, AquisitoCoreKtor_utilsMonthCompanion, AquisitoCoreKtor_utilsMonth, AquisitoCoreKtor_utilsGMTDateCompanion, AquisitoCoreKtor_utilsGMTDate, AquisitoCoreKtor_utilsAttributeKey<T>, AquisitoCoreKtor_ioMemoryCompanion, AquisitoCoreKtor_ioMemory, AquisitoCoreKtor_ioInputCompanion, AquisitoCoreKtor_ioInput, AquisitoCoreKtor_ioChunkBufferCompanion, AquisitoCoreKtor_ioChunkBuffer, AquisitoCoreKtor_ioByteReadPacketCompanion, AquisitoCoreKtor_ioByteReadPacket, AquisitoCoreKtor_ioBufferCompanion, AquisitoCoreKtor_ioBuffer, AquisitoCoreKtor_httpUrlCompanion, AquisitoCoreKtor_httpUrl, AquisitoCoreKtor_httpURLProtocolCompanion, AquisitoCoreKtor_httpURLProtocol, AquisitoCoreKtor_httpURLBuilderCompanion, AquisitoCoreKtor_httpURLBuilder, AquisitoCoreKtor_httpOutgoingContentWriteChannelContent, AquisitoCoreKtor_httpOutgoingContentReadChannelContent, AquisitoCoreKtor_httpOutgoingContentProtocolUpgrade, AquisitoCoreKtor_httpOutgoingContentNoContent, AquisitoCoreKtor_httpOutgoingContentByteArrayContent, AquisitoCoreKtor_httpOutgoingContent, AquisitoCoreKtor_httpHttpStatusCodeCompanion, AquisitoCoreKtor_httpHttpStatusCode, AquisitoCoreKtor_httpHttpProtocolVersionCompanion, AquisitoCoreKtor_httpHttpProtocolVersion, AquisitoCoreKtor_httpHttpMethodCompanion, AquisitoCoreKtor_httpHttpMethod, AquisitoCoreKtor_httpHeadersBuilder, AquisitoCoreKtor_httpHeaderValueWithParametersCompanion, AquisitoCoreKtor_httpHeaderValueWithParameters, AquisitoCoreKtor_httpHeaderValueParam, AquisitoCoreKtor_httpContentTypeCompanion, AquisitoCoreKtor_httpContentType, AquisitoCoreKtor_eventsEvents, AquisitoCoreKtor_eventsEventDefinition<T>, AquisitoCoreKtor_client_coreProxyConfig, AquisitoCoreKtor_client_coreHttpSendPipelinePhases, AquisitoCoreKtor_client_coreHttpSendPipeline, AquisitoCoreKtor_client_coreHttpResponsePipelinePhases, AquisitoCoreKtor_client_coreHttpResponsePipeline, AquisitoCoreKtor_client_coreHttpResponseData, AquisitoCoreKtor_client_coreHttpResponseContainer, AquisitoCoreKtor_client_coreHttpResponse, AquisitoCoreKtor_client_coreHttpRequestPipelinePhases, AquisitoCoreKtor_client_coreHttpRequestPipeline, AquisitoCoreKtor_client_coreHttpRequestData, AquisitoCoreKtor_client_coreHttpRequestBuilderCompanion, AquisitoCoreKtor_client_coreHttpRequestBuilder, AquisitoCoreKtor_client_coreHttpReceivePipelinePhases, AquisitoCoreKtor_client_coreHttpReceivePipeline, AquisitoCoreKtor_client_coreHttpClientEngineConfig, AquisitoCoreKtor_client_coreHttpClientConfig<T>, AquisitoCoreKtor_client_coreHttpClientCallCompanion, AquisitoCoreKtor_client_coreHttpClientCall, AquisitoCoreKtor_client_coreHttpClient, AquisitoCoreKotlinx_serialization_jsonJsonPrimitiveCompanion, AquisitoCoreKotlinx_serialization_jsonJsonPrimitive, AquisitoCoreKotlinx_serialization_jsonJsonNull, AquisitoCoreKotlinx_serialization_jsonJsonElementCompanion, AquisitoCoreKotlinx_serialization_jsonJsonElement, AquisitoCoreKotlinx_serialization_coreStructureKindOBJECT, AquisitoCoreKotlinx_serialization_coreStructureKindMAP, AquisitoCoreKotlinx_serialization_coreStructureKindLIST, AquisitoCoreKotlinx_serialization_coreStructureKindCLASS, AquisitoCoreKotlinx_serialization_coreStructureKind, AquisitoCoreKotlinx_serialization_coreSerializersModule, AquisitoCoreKotlinx_serialization_coreSerialKindENUM, AquisitoCoreKotlinx_serialization_coreSerialKindCONTEXTUAL, AquisitoCoreKotlinx_serialization_coreSerialKind, AquisitoCoreKotlinx_serialization_corePrimitiveKindSTRING, AquisitoCoreKotlinx_serialization_corePrimitiveKindSHORT, AquisitoCoreKotlinx_serialization_corePrimitiveKindLONG, AquisitoCoreKotlinx_serialization_corePrimitiveKindINT, AquisitoCoreKotlinx_serialization_corePrimitiveKindFLOAT, AquisitoCoreKotlinx_serialization_corePrimitiveKindDOUBLE, AquisitoCoreKotlinx_serialization_corePrimitiveKindCHAR, AquisitoCoreKotlinx_serialization_corePrimitiveKindBYTE, AquisitoCoreKotlinx_serialization_corePrimitiveKindBOOLEAN, AquisitoCoreKotlinx_serialization_corePrimitiveKind, AquisitoCoreKotlinx_serialization_corePolymorphicKindSEALED, AquisitoCoreKotlinx_serialization_corePolymorphicKindOPEN, AquisitoCoreKotlinx_serialization_corePolymorphicKind, AquisitoCoreKotlinx_coroutines_coreCoroutineDispatcherKey, AquisitoCoreKotlinx_coroutines_coreCoroutineDispatcher, AquisitoCoreKotlinUnit, AquisitoCoreKotlinThrowable, AquisitoCoreKotlinRuntimeException, AquisitoCoreKotlinPair<A, B>, AquisitoCoreKotlinNothing, AquisitoCoreKotlinLongRangeCompanion, AquisitoCoreKotlinLongRange, AquisitoCoreKotlinLongProgressionCompanion, AquisitoCoreKotlinLongProgression, AquisitoCoreKotlinLongIterator, AquisitoCoreKotlinLazyThreadSafetyMode, AquisitoCoreKotlinKVariance, AquisitoCoreKotlinKTypeProjectionCompanion, AquisitoCoreKotlinKTypeProjection, AquisitoCoreKotlinIllegalStateException, AquisitoCoreKotlinException, AquisitoCoreKotlinEnumCompanion, AquisitoCoreKotlinEnum<E>, AquisitoCoreKotlinCancellationException, AquisitoCoreKotlinByteIterator, AquisitoCoreKotlinByteArray, AquisitoCoreKotlinArray<T>, AquisitoCoreKotlinAbstractCoroutineContextKey<B, E>, AquisitoCoreKotlinAbstractCoroutineContextElement, AquisitoCoreKoin_coreSingleInstanceFactory<T>, AquisitoCoreKoin_coreScopeRegistryCompanion, AquisitoCoreKoin_coreScopeRegistry, AquisitoCoreKoin_coreScopeDSL, AquisitoCoreKoin_coreScope, AquisitoCoreKoin_corePropertyRegistry, AquisitoCoreKoin_coreParametersHolder, AquisitoCoreKoin_coreModule, AquisitoCoreKoin_coreLogger, AquisitoCoreKoin_coreLockable, AquisitoCoreKoin_coreLevel, AquisitoCoreKoin_coreKoinDefinition<R>, AquisitoCoreKoin_coreKoinApplicationCompanion, AquisitoCoreKoin_coreKoinApplication, AquisitoCoreKoin_coreKoin, AquisitoCoreKoin_coreKind, AquisitoCoreKoin_coreInstanceRegistry, AquisitoCoreKoin_coreInstanceFactoryCompanion, AquisitoCoreKoin_coreInstanceFactory<T>, AquisitoCoreKoin_coreInstanceContext, AquisitoCoreKoin_coreExtensionManager, AquisitoCoreKoin_coreCallbacks<T>, AquisitoCoreKoin_coreBeanDefinition<T>, AquisitoCoreKoinStarterKt, AquisitoCoreKmpFileCompanion, AquisitoCoreKmpFile, AquisitoCoreKeyValueStorageFactoryKt, AquisitoCoreJsonNapierLogger, AquisitoCoreIosLocationClientKt, AquisitoCoreInt, AquisitoCoreImageMediaDtoCompanion, AquisitoCoreImageMediaDto, AquisitoCoreImageMedia, AquisitoCoreIOSPlatform, AquisitoCoreIOSKeyValueStorage, AquisitoCoreHttpClientFactory, AquisitoCoreHaversineKt, AquisitoCoreGroupedMenuEntryDtoCompanion, AquisitoCoreGroupedMenuEntryDto, AquisitoCoreGroupedMenuEntry, AquisitoCoreGroupedAreaDtoCompanion, AquisitoCoreGroupedAreaDto, AquisitoCoreGroupedArea, AquisitoCoreGetUserDataUseCase, AquisitoCoreGetUserDataOnContextUseCase, AquisitoCoreGetUserCollectionsUseCase, AquisitoCoreGetPromotionDetailUseCase, AquisitoCoreGetPlacesUseCase, AquisitoCoreGetPlaceDetailUseCase, AquisitoCoreGetOnboardingStatusUseCase, AquisitoCoreGetListRatingsUseCase, AquisitoCoreGetCartDetailUseCase, AquisitoCoreGetAvailableAreasUseCase, AquisitoCoreGetAvailableAreaByLocationUseCase, AquisitoCoreGeoPoint, AquisitoCoreForgotPasswordUseCase, AquisitoCoreForgotPasswordRequestDtoCompanion, AquisitoCoreForgotPasswordRequestDto, AquisitoCoreFloat, AquisitoCoreFakeLocationClient, AquisitoCoreErrorResponseDtoCompanion, AquisitoCoreErrorResponseDto, AquisitoCoreErrorHandler, AquisitoCoreError, AquisitoCoreEnsureSetLocationUserUseCase, AquisitoCoreDouble, AquisitoCoreDistrictDtoCompanion, AquisitoCoreDistrictDto, AquisitoCoreDistrictCompanion, AquisitoCoreDistrict, AquisitoCoreDepartmentDtoCompanion, AquisitoCoreDepartmentDto, AquisitoCoreDepartmentCompanion, AquisitoCoreDepartment, AquisitoCoreDeleteAccountUseCase, AquisitoCoreDateTime_iosKt, AquisitoCoreDatabaseFactory, AquisitoCoreDatabaseBuilder_iosKt, AquisitoCoreDataResponseCompanion, AquisitoCoreDataResponse<T>, AquisitoCoreCurrencySymbolPosition, AquisitoCoreCurrencyManager, AquisitoCoreCurrencyFormatterKt, AquisitoCoreCurrencyCompanion, AquisitoCoreCurrency, AquisitoCoreCuisineDtoCompanion, AquisitoCoreCuisineDto, AquisitoCoreCuisine, AquisitoCoreCreateCollectionUseCase, AquisitoCoreCreateCollectionRequestDtoCompanion, AquisitoCoreCreateCollectionRequestDto, AquisitoCoreCoreModuleKt, AquisitoCoreCollectionRepositoryImpl, AquisitoCoreCollectionModuleKt, AquisitoCoreCollectionEntity, AquisitoCoreCollectionDtoCompanion, AquisitoCoreCollectionDto, AquisitoCoreCollectionDao_ImplCompanion, AquisitoCoreCollectionDao_Impl, AquisitoCoreCollectionApi, AquisitoCoreCollection, AquisitoCoreCheckUserLocationUseCase, AquisitoCoreCategoryDtoCompanion, AquisitoCoreCategoryDto, AquisitoCoreCategory, AquisitoCoreCartModuleKt, AquisitoCoreCartEntryDtoCompanion, AquisitoCoreCartEntryDto, AquisitoCoreCartEntry, AquisitoCoreCartApi, AquisitoCoreByte, AquisitoCoreBoolean, AquisitoCoreBase, AquisitoCoreAvailableAreaDtoCompanion, AquisitoCoreAvailableAreaDto, AquisitoCoreAvailableArea, AquisitoCoreAuthorDtoCompanion, AquisitoCoreAuthorDto, AquisitoCoreAuthor, AquisitoCoreAuthenticationModuleKt, AquisitoCoreAuthLocalDataSourceImplCompanion, AquisitoCoreAuthLocalDataSourceImpl, AquisitoCoreAuthEventLoggedOut, AquisitoCoreAuthEventLoggedIn, AquisitoCoreAuthEvent, AquisitoCoreAuthApi, AquisitoCoreAuthActionResult, AquisitoCoreAuthActionResponseDtoCompanion, AquisitoCoreAuthActionResponseDto, AquisitoCoreAreaModuleKt, AquisitoCoreAreaApi, AquisitoCoreAquisitoConfig, AquisitoCoreAppDatabase_Impl, AquisitoCoreAppDatabaseConstructor, AquisitoCoreAppDatabase, AquisitoCoreApiConstantUser, AquisitoCoreApiConstantRatingPlace, AquisitoCoreApiConstantPromotion, AquisitoCoreApiConstantPlace, AquisitoCoreApiConstantCollection, AquisitoCoreApiConstantAuth, AquisitoCoreApiConstantArea, AquisitoCoreApiConstant, AquisitoCoreAmenityDtoCompanion, AquisitoCoreAmenityDto, AquisitoCoreAmenity, AquisitoCoreAddPlaceToCollectionUseCase, AquisitoCoreAddPlaceToCollectionRequestDtoCompanion, AquisitoCoreAddPlaceToCollectionRequestDto;

@protocol NSCopying, AquisitoCoreUserRepository, AquisitoCoreSqliteSQLiteStatement, AquisitoCoreSqliteSQLiteConnection, AquisitoCoreSkie_DispatcherDelegate, AquisitoCoreSessionManager, AquisitoCoreRoom_runtimeRoomOpenDelegateMarker, AquisitoCoreRoom_runtimeRoomDatabaseConstructor, AquisitoCoreRoom_runtimeAutoMigrationSpec, AquisitoCoreResultViewState, AquisitoCoreRatingPlaceRepository, AquisitoCorePromotionRepository, AquisitoCorePlatform, AquisitoCorePlaceRepository, AquisitoCoreOnboardingRepository, AquisitoCoreLocationStorage, AquisitoCoreLocationRepository, AquisitoCoreLocationClient, AquisitoCoreKtor_utilsStringValuesBuilder, AquisitoCoreKtor_utilsStringValues, AquisitoCoreKtor_utilsAttributes, AquisitoCoreKtor_ioReadSession, AquisitoCoreKtor_ioObjectPool, AquisitoCoreKtor_ioCloseable, AquisitoCoreKtor_ioByteWriteChannel, AquisitoCoreKtor_ioByteReadChannel, AquisitoCoreKtor_httpParametersBuilder, AquisitoCoreKtor_httpParameters, AquisitoCoreKtor_httpHttpMessageBuilder, AquisitoCoreKtor_httpHttpMessage, AquisitoCoreKtor_httpHeaders, AquisitoCoreKtor_client_loggingLogger, AquisitoCoreKtor_client_coreHttpRequest, AquisitoCoreKtor_client_coreHttpClientPlugin, AquisitoCoreKtor_client_coreHttpClientEngineCapability, AquisitoCoreKtor_client_coreHttpClientEngine, AquisitoCoreKotlinx_serialization_coreSerializersModuleCollector, AquisitoCoreKotlinx_serialization_coreSerializationStrategy, AquisitoCoreKotlinx_serialization_coreSerialDescriptor, AquisitoCoreKotlinx_serialization_coreKSerializer, AquisitoCoreKotlinx_serialization_coreEncoder, AquisitoCoreKotlinx_serialization_coreDeserializationStrategy, AquisitoCoreKotlinx_serialization_coreDecoder, AquisitoCoreKotlinx_serialization_coreCompositeEncoder, AquisitoCoreKotlinx_serialization_coreCompositeDecoder, AquisitoCoreKotlinx_coroutines_coreStateFlow, AquisitoCoreKotlinx_coroutines_coreSharedFlow, AquisitoCoreKotlinx_coroutines_coreSelectInstance, AquisitoCoreKotlinx_coroutines_coreSelectClause2, AquisitoCoreKotlinx_coroutines_coreSelectClause1, AquisitoCoreKotlinx_coroutines_coreSelectClause0, AquisitoCoreKotlinx_coroutines_coreSelectClause, AquisitoCoreKotlinx_coroutines_coreRunnable, AquisitoCoreKotlinx_coroutines_coreParentJob, AquisitoCoreKotlinx_coroutines_coreMutableStateFlow, AquisitoCoreKotlinx_coroutines_coreMutableSharedFlow, AquisitoCoreKotlinx_coroutines_coreJob, AquisitoCoreKotlinx_coroutines_coreFlowCollector, AquisitoCoreKotlinx_coroutines_coreFlow, AquisitoCoreKotlinx_coroutines_coreDisposableHandle, AquisitoCoreKotlinx_coroutines_coreCoroutineScope, AquisitoCoreKotlinx_coroutines_coreChildJob, AquisitoCoreKotlinx_coroutines_coreChildHandle, AquisitoCoreKotlinSuspendFunction2, AquisitoCoreKotlinSuspendFunction1, AquisitoCoreKotlinSequence, AquisitoCoreKotlinOpenEndRange, AquisitoCoreKotlinMapEntry, AquisitoCoreKotlinLazy, AquisitoCoreKotlinKType, AquisitoCoreKotlinKDeclarationContainer, AquisitoCoreKotlinKClassifier, AquisitoCoreKotlinKClass, AquisitoCoreKotlinKAnnotatedElement, AquisitoCoreKotlinIterator, AquisitoCoreKotlinIterable, AquisitoCoreKotlinFunction, AquisitoCoreKotlinCoroutineContextKey, AquisitoCoreKotlinCoroutineContextElement, AquisitoCoreKotlinCoroutineContext, AquisitoCoreKotlinContinuationInterceptor, AquisitoCoreKotlinContinuation, AquisitoCoreKotlinComparable, AquisitoCoreKotlinClosedRange, AquisitoCoreKotlinAutoCloseable, AquisitoCoreKotlinAppendable, AquisitoCoreKotlinAnnotation, AquisitoCoreKoin_coreScopeCallback, AquisitoCoreKoin_coreQualifier, AquisitoCoreKoin_coreKoinScopeComponent, AquisitoCoreKoin_coreKoinExtension, AquisitoCoreKoin_coreKoinComponent, AquisitoCoreKeyValueStorage, AquisitoCoreCollectionRepository, AquisitoCoreCollectionDao, AquisitoCoreClock, AquisitoCoreCartRepository, AquisitoCoreAuthTokenInvalidator, AquisitoCoreAuthRepository, AquisitoCoreAuthLocalDataSource, AquisitoCoreAreaRepository;
...
typedef id<AquisitoCoreResultViewState> _Nonnull Skie__TypeDef__0__id_AquisitoCoreResultViewState_ __attribute__((__swift_private__));
typedef id<AquisitoCoreResultViewState> _Nullable Skie__TypeDef__1__id_AquisitoCoreResultViewState___Nullable __attribute__((__swift_private__));
typedef id<AquisitoCoreKoin_coreQualifier> _Nonnull Skie__TypeDef__2__id_AquisitoCoreKoin_coreQualifier_ __attribute__((__swift_private__));
typedef id<AquisitoCoreKoin_coreKoinExtension> _Nonnull Skie__TypeDef__3__id_AquisitoCoreKoin_coreKoinExtension_ __attribute__((__swift_private__));
typedef id<AquisitoCoreKoin_coreKoinExtension> _Nullable Skie__TypeDef__4__id_AquisitoCoreKoin_coreKoinExtension___Nullable __attribute__((__swift_private__));
typedef id<AquisitoCoreCartRepository> _Nonnull Skie__TypeDef__5__id_AquisitoCoreCartRepository_ __attribute__((__swift_private__));
...
@interface AquisitoCoreSkieColdFlowIterator<E> : AquisitoCoreBase
- (instancetype)initWithFlow:(id<AquisitoCoreKotlinx_coroutines_coreFlow>)flow __attribute__((swift_name("init(flow:)"))) __attribute__((objc_designated_initializer));
...
*/
- (void)hasNextWithCompletionHandler:(void (^)(AquisitoCoreBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("hasNext(completionHandler:)")));
...
@interface AquisitoCoreSkieKotlinFlow<__covariant T> : AquisitoCoreBase <AquisitoCoreKotlinx_coroutines_coreFlow>
- (instancetype)initWithDelegate:(id<AquisitoCoreKotlinx_coroutines_coreFlow>)delegate __attribute__((swift_name("init(_:)"))) __attribute__((objc_designated_initializer));
...
@protocol AquisitoCoreKotlinx_coroutines_coreMutableSharedFlow <AquisitoCoreKotlinx_coroutines_coreSharedFlow, AquisitoCoreKotlinx_coroutines_coreFlowCollector>
@required
...
@property (readonly) id<AquisitoCoreKotlinx_coroutines_coreStateFlow> subscriptionCount __attribute__((swift_name("subscriptionCount")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SkieKotlinMutableSharedFlow")))
@interface AquisitoCoreSkieKotlinMutableSharedFlow<T> : AquisitoCoreBase <AquisitoCoreKotlinx_coroutines_coreMutableSharedFlow>
@property (readonly) NSArray<T> *replayCache __attribute__((swift_name("replayCache")));
@property (readonly) id<AquisitoCoreKotlinx_coroutines_coreStateFlow> subscriptionCount __attribute__((swift_name("subscriptionCount")));
- (instancetype)initWithDelegate:(id<AquisitoCoreKotlinx_coroutines_coreMutableSharedFlow>)delegate __attribute__((swift_name("init(_:)"))) __attribute__((objc_designated_initializer));
...
@protocol AquisitoCoreKotlinx_coroutines_coreMutableStateFlow <AquisitoCoreKotlinx_coroutines_coreStateFlow, AquisitoCoreKotlinx_coroutines_coreMutableSharedFlow>
@required
...
@interface AquisitoCoreSkieKotlinMutableStateFlow<T> : AquisitoCoreBase <AquisitoCoreKotlinx_coroutines_coreMutableStateFlow>
@property (readonly) NSArray<T> *replayCache __attribute__((swift_name("replayCache")));
@property (readonly) id<AquisitoCoreKotlinx_coroutines_coreStateFlow> subscriptionCount __attribute__((swift_name("subscriptionCount")));
@property T value __attribute__((swift_name("value")));
- (instancetype)initWithDelegate:(id<AquisitoCoreKotlinx_coroutines_coreMutableStateFlow>)delegate __attribute__((swift_name("init(_:)"))) __attribute__((objc_designated_initializer));
...
@interface AquisitoCoreSkieKotlinOptionalFlow<__covariant T> : AquisitoCoreBase <AquisitoCoreKotlinx_coroutines_coreFlow>
- (instancetype)initWithDelegate:(id<AquisitoCoreKotlinx_coroutines_coreFlow>)delegate __attribute__((swift_name("init(_:)"))) __attribute__((objc_designated_initializer));
...
@interface AquisitoCoreSkieKotlinOptionalMutableSharedFlow<T> : AquisitoCoreBase <AquisitoCoreKotlinx_coroutines_coreMutableSharedFlow>
@property (readonly) NSArray<id> *replayCache __attribute__((swift_name("replayCache")));
@property (readonly) id<AquisitoCoreKotlinx_coroutines_coreStateFlow> subscriptionCount __attribute__((swift_name("subscriptionCount")));
- (instancetype)initWithDelegate:(id<AquisitoCoreKotlinx_coroutines_coreMutableSharedFlow>)delegate __attribute__((swift_name("init(_:)"))) __attribute__((objc_designated_initializer));
...
@interface AquisitoCoreSkieKotlinOptionalMutableStateFlow<T> : AquisitoCoreBase <AquisitoCoreKotlinx_coroutines_coreMutableStateFlow>
@property (readonly) NSArray<id> *replayCache __attribute__((swift_name("replayCache")));
@property (readonly) id<AquisitoCoreKotlinx_coroutines_coreStateFlow> subscriptionCount __attribute__((swift_name("subscriptionCount")));
...
@interface AquisitoCoreSkieKotlinOptionalSharedFlow<__covariant T> : AquisitoCoreBase <AquisitoCoreKotlinx_coroutines_coreSharedFlow>
@property (readonly) NSArray<id> *replayCache __attribute__((swift_name("replayCache")));
- (instancetype)initWithDelegate:(id<AquisitoCoreKotlinx_coroutines_coreSharedFlow>)delegate __attribute__((swift_name("init(_:)"))) __attribute__((objc_designated_initializer));
...
@interface AquisitoCoreSkieKotlinOptionalStateFlow<__covariant T> : AquisitoCoreBase <AquisitoCoreKotlinx_coroutines_coreStateFlow>
@property (readonly) NSArray<id> *replayCache __attribute__((swift_name("replayCache")));
@property (readonly) T _Nullable value __attribute__((swift_name("value")));
- (instancetype)initWithDelegate:(id<AquisitoCoreKotlinx_coroutines_coreStateFlow>)delegate __attribute__((swift_name("init(_:)"))) __attribute__((objc_designated_initializer));
...
@interface AquisitoCoreSkieKotlinSharedFlow<__covariant T> : AquisitoCoreBase <AquisitoCoreKotlinx_coroutines_coreSharedFlow>
@property (readonly) NSArray<T> *replayCache __attribute__((swift_name("replayCache")));
- (instancetype)initWithDelegate:(id<AquisitoCoreKotlinx_coroutines_coreSharedFlow>)delegate __attribute__((swift_name("init(_:)"))) __attribute__((objc_designated_initializer));
...
@interface AquisitoCoreSkieKotlinStateFlow<__covariant T> : AquisitoCoreBase <AquisitoCoreKotlinx_coroutines_coreStateFlow>
@property (readonly) NSArray<T> *replayCache __attribute__((swift_name("replayCache")));
...
@interface AquisitoCoreSkie_CancellationHandler : AquisitoCoreBase
...
@protocol AquisitoCoreSkie_DispatcherDelegate
@required
- (void)dispatchBlock:(id<AquisitoCoreKotlinx_coroutines_coreRunnable>)block __attribute__((swift_name("dispatch(block:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Skie_SuspendHandler")))
@interface AquisitoCoreSkie_SuspendHandler : AquisitoCoreBase
- (instancetype)initWithCancellationHandler:(AquisitoCoreSkie_CancellationHandler *)cancellationHandler dispatcherDelegate:(id<AquisitoCoreSkie_DispatcherDelegate>)dispatcherDelegate onResult:(void (^)(AquisitoCoreSkie_SuspendResult *))onResult __attribute__((swift_name("init(cancellationHandler:dispatcherDelegate:onResult:)"))) __attribute__((objc_designated_initializer));
@end

__attribute__((swift_name("Skie_SuspendResult")))
@interface AquisitoCoreSkie_SuspendResult : AquisitoCoreBase
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Skie_SuspendResult.Canceled")))
@interface AquisitoCoreSkie_SuspendResultCanceled : AquisitoCoreSkie_SuspendResult
@property (class, readonly, getter=shared) AquisitoCoreSkie_SuspendResultCanceled *shared __attribute__((swift_name("shared")));
...
@interface AquisitoCoreSkie_SuspendResultError : AquisitoCoreSkie_SuspendResult
...
- (AquisitoCoreSkie_SuspendResultError *)doCopyError:(NSError *)error __attribute__((swift_name("doCopy(error:)")));
...
@interface AquisitoCoreSkie_SuspendResultSuccess : AquisitoCoreSkie_SuspendResult
@property (readonly) id _Nullable value __attribute__((swift_name("value")));
...
- (AquisitoCoreSkie_SuspendResultSuccess *)doCopyValue:(id _Nullable)value __attribute__((swift_name("doCopy(value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
- (AquisitoCoreGetPromotionDetailUseCase *)getGetPromotionDetailUseCase __attribute__((swift_name("getGetPromotionDetailUseCase()")));
...
- (AquisitoCoreListPlacePromotionsUseCase *)getListPlacePromotionsUseCase __attribute__((swift_name("getListPlacePromotionsUseCase()")));
...
- (AquisitoCoreRedeemPromotionUseCase *)getRedeemPromotionUseCase __attribute__((swift_name("getRedeemPromotionUseCase()")));
...
- (AquisitoCoreUpdatePasswordUseCase *)getUpdatePasswordUseCase __attribute__((swift_name("getUpdatePasswordUseCase()")));
- (AquisitoCoreUpdateUserProfileUseCase *)getUpdateUserProfileUseCase __attribute__((swift_name("getUpdateUserProfileUseCase()")));
...
@interface AquisitoCoreRoom_runtimeRoomDatabase : AquisitoCoreBase
@property (readonly) AquisitoCoreRoom_runtimeInvalidationTracker *invalidationTracker __attribute__((swift_name("invalidationTracker")));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (NSArray<AquisitoCoreRoom_runtimeMigration *> *)createAutoMigrationsAutoMigrationSpecs:(NSDictionary<id<AquisitoCoreKotlinKClass>, id<AquisitoCoreRoom_runtimeAutoMigrationSpec>> *)autoMigrationSpecs __attribute__((swift_name("createAutoMigrations(autoMigrationSpecs:)")));

/**
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (AquisitoCoreRoom_runtimeInvalidationTracker *)createInvalidationTracker __attribute__((swift_name("createInvalidationTracker()")));
 ...
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (id<AquisitoCoreRoom_runtimeRoomOpenDelegateMarker>)createOpenDelegate __attribute__((swift_name("createOpenDelegate()")));

/**
 * @note annotations
 *   androidx.annotation.RestrictTo(value=[Scope.LIBRARY_GROUP])
*/
- (id<AquisitoCoreKotlinx_coroutines_coreCoroutineScope>)getCoroutineScope __attribute__((swift_name("getCoroutineScope()")));

/**
 * @note annotations
 *   androidx.annotation.RestrictTo(value=[Scope.LIBRARY_GROUP_PREFIX])
*/
- (NSSet<id<AquisitoCoreKotlinKClass>> *)getRequiredAutoMigrationSpecClasses __attribute__((swift_name("getRequiredAutoMigrationSpecClasses()")));
 ...
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (NSDictionary<id<AquisitoCoreKotlinKClass>, NSArray<id<AquisitoCoreKotlinKClass>> *> *)getRequiredTypeConverterClasses __attribute__((swift_name("getRequiredTypeConverterClasses()")));

/**
 * @note annotations
 *   androidx.annotation.RestrictTo(value=[Scope.LIBRARY_GROUP_PREFIX])
*/
- (id)getTypeConverterKlass:(id<AquisitoCoreKotlinKClass>)klass __attribute__((swift_name("getTypeConverter(klass:)")));
 ...
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (void)internalInitInvalidationTrackerConnection:(id<AquisitoCoreSqliteSQLiteConnection>)connection __attribute__((swift_name("internalInitInvalidationTracker(connection:)")));
@end

__attribute__((swift_name("AppDatabase")))
@interface AquisitoCoreAppDatabase : AquisitoCoreRoom_runtimeRoomDatabase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (id<AquisitoCoreCollectionDao>)collectionDao __attribute__((swift_name("collectionDao()")));
@end

__attribute__((swift_name("Room_runtimeRoomDatabaseConstructor")))
@protocol AquisitoCoreRoom_runtimeRoomDatabaseConstructor
@required
- (AquisitoCoreRoom_runtimeRoomDatabase *)initialize __attribute__((swift_name("initialize()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppDatabaseConstructor")))
@interface AquisitoCoreAppDatabaseConstructor : AquisitoCoreBase <AquisitoCoreRoom_runtimeRoomDatabaseConstructor>
@property (class, readonly, getter=shared) AquisitoCoreAppDatabaseConstructor *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)appDatabaseConstructor __attribute__((swift_name("init()")));
- (AquisitoCoreAppDatabase *)initialize __attribute__((swift_name("initialize()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppDatabase_Impl")))
@interface AquisitoCoreAppDatabase_Impl : AquisitoCoreAppDatabase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (id<AquisitoCoreCollectionDao>)collectionDao __attribute__((swift_name("collectionDao()")));
- (NSArray<AquisitoCoreRoom_runtimeMigration *> *)createAutoMigrationsAutoMigrationSpecs:(NSDictionary<id<AquisitoCoreKotlinKClass>, id<AquisitoCoreRoom_runtimeAutoMigrationSpec>> *)autoMigrationSpecs __attribute__((swift_name("createAutoMigrations(autoMigrationSpecs:)")));
 ...
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (AquisitoCoreRoom_runtimeRoomOpenDelegate *)createOpenDelegate __attribute__((swift_name("createOpenDelegate()")));
- (NSSet<id<AquisitoCoreKotlinKClass>> *)getRequiredAutoMigrationSpecClasses __attribute__((swift_name("getRequiredAutoMigrationSpecClasses()")));
...
@interface AquisitoCoreDatabaseFactory : AquisitoCoreBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AquisitoCoreAppDatabase *)createDatabase __attribute__((swift_name("createDatabase()")));
@end
...
__attribute__((swift_name("CollectionDao")))
@protocol AquisitoCoreCollectionDao
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)clearCollectionsWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("clearCollections(completionHandler:)")));
- (id<AquisitoCoreKotlinx_coroutines_coreFlow>)getCollectionsAsFlow __attribute__((swift_name("getCollectionsAsFlow()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)insertCollectionsCollections:(NSArray<AquisitoCoreCollectionEntity *> *)collections completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("insertCollections(collections:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CollectionDao_Impl")))
@interface AquisitoCoreCollectionDao_Impl : AquisitoCoreBase <AquisitoCoreCollectionDao>
@property (class, readonly, getter=companion) AquisitoCoreCollectionDao_ImplCompanion *companion __attribute__((swift_name("companion")));
- (instancetype)initWith__db:(AquisitoCoreRoom_runtimeRoomDatabase *)__db __attribute__((swift_name("init(__db:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CollectionDao_Impl.Companion")))
@interface AquisitoCoreCollectionDao_ImplCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCoreCollectionDao_ImplCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (NSArray<id<AquisitoCoreKotlinKClass>> *)getRequiredConverters __attribute__((swift_name("getRequiredConverters()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CollectionEntity")))
@interface AquisitoCoreCollectionEntity : AquisitoCoreBase
...
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly) NSString *placesJson __attribute__((swift_name("placesJson")));
...
- (instancetype)initWithId:(int32_t)id slug:(NSString *)slug name:(NSString *)name description:(NSString * _Nullable)description type:(NSString *)type isPublic:(BOOL)isPublic trackChanges:(BOOL)trackChanges placesJson:(NSString *)placesJson createdAt:(NSString * _Nullable)createdAt __attribute__((swift_name("init(id:slug:name:description:type:isPublic:trackChanges:placesJson:createdAt:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreCollectionEntity *)doCopyId:(int32_t)id slug:(NSString *)slug name:(NSString *)name description:(NSString * _Nullable)description type:(NSString *)type isPublic:(BOOL)isPublic trackChanges:(BOOL)trackChanges placesJson:(NSString *)placesJson createdAt:(NSString * _Nullable)createdAt __attribute__((swift_name("doCopy(id:slug:name:description:type:isPublic:trackChanges:placesJson:createdAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((swift_name("AuthTokenInvalidator")))
@protocol AquisitoCoreAuthTokenInvalidator
@required
...
- (AquisitoCoreKtor_client_coreHttpClient *)createAuthLocalDataSource:(id<AquisitoCoreAuthLocalDataSource>)authLocalDataSource __attribute__((swift_name("create(authLocalDataSource:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UpdatePasswordRequestDto")))
@interface AquisitoCoreUpdatePasswordRequestDto : AquisitoCoreBase
@property (class, readonly, getter=companion) AquisitoCoreUpdatePasswordRequestDtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *current_password __attribute__((swift_name("current_password")));
@property (readonly) NSString *password __attribute__((swift_name("password")));
@property (readonly) NSString *password_confirmation __attribute__((swift_name("password_confirmation")));
- (instancetype)initWithCurrent_password:(NSString *)current_password password:(NSString *)password password_confirmation:(NSString *)password_confirmation __attribute__((swift_name("init(current_password:password:password_confirmation:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreUpdatePasswordRequestDto *)doCopyCurrent_password:(NSString *)current_password password:(NSString *)password password_confirmation:(NSString *)password_confirmation __attribute__((swift_name("doCopy(current_password:password:password_confirmation:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UpdatePasswordRequestDto.Companion")))
@interface AquisitoCoreUpdatePasswordRequestDtoCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCoreUpdatePasswordRequestDtoCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AquisitoCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UpdateUserProfileRequestDto")))
@interface AquisitoCoreUpdateUserProfileRequestDto : AquisitoCoreBase
@property (class, readonly, getter=companion) AquisitoCoreUpdateUserProfileRequestDtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *birth_date __attribute__((swift_name("birth_date")));
@property (readonly) NSString *email __attribute__((swift_name("email")));
...
- (instancetype)initWithFirst_name:(NSString *)first_name last_name:(NSString *)last_name email:(NSString *)email birth_date:(NSString *)birth_date phone:(NSString *)phone __attribute__((swift_name("init(first_name:last_name:email:birth_date:phone:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreUpdateUserProfileRequestDto *)doCopyFirst_name:(NSString *)first_name last_name:(NSString *)last_name email:(NSString *)email birth_date:(NSString *)birth_date phone:(NSString *)phone __attribute__((swift_name("doCopy(first_name:last_name:email:birth_date:phone:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UpdateUserProfileRequestDto.Companion")))
@interface AquisitoCoreUpdateUserProfileRequestDtoCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCoreUpdateUserProfileRequestDtoCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AquisitoCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@property (readonly) AquisitoCoreKotlinx_serialization_jsonJsonElement * _Nullable rawErrors __attribute__((swift_name("rawErrors")));
- (instancetype)initWithMessage:(NSString *)message rawErrors:(AquisitoCoreKotlinx_serialization_jsonJsonElement * _Nullable)rawErrors __attribute__((swift_name("init(message:rawErrors:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreErrorResponseDto *)doCopyMessage:(NSString *)message rawErrors:(AquisitoCoreKotlinx_serialization_jsonJsonElement * _Nullable)rawErrors __attribute__((swift_name("doCopy(message:rawErrors:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString * _Nullable ambience_avg_score __attribute__((swift_name("ambience_avg_score")));
...
@property (readonly) NSArray<AquisitoCoreLinkDto *> *deliveryLinks __attribute__((swift_name("deliveryLinks")));
...
@property (readonly) AquisitoCoreBoolean * _Nullable featured __attribute__((swift_name("featured")));
@property (readonly) NSString * _Nullable food_avg_score __attribute__((swift_name("food_avg_score")));
@property (readonly) NSArray<NSString *> * _Nullable gallery __attribute__((swift_name("gallery")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) AquisitoCoreBoolean * _Nullable is_favorite __attribute__((swift_name("is_favorite")));
...
@property (readonly) NSString * _Nullable price_avg_score __attribute__((swift_name("price_avg_score")));
...
@property (readonly) NSString * _Nullable service_avg_score __attribute__((swift_name("service_avg_score")));
@property (readonly) NSString *slug __attribute__((swift_name("slug")));
...
@property (readonly) NSArray<NSString *> * _Nullable gallery __attribute__((swift_name("gallery")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) AquisitoCoreBoolean * _Nullable is_liked __attribute__((swift_name("is_liked")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionDto")))
@interface AquisitoCorePromotionDto : AquisitoCoreBase
@property (class, readonly, getter=companion) AquisitoCorePromotionDtoCompanion *companion __attribute__((swift_name("companion")));
...
@property (readonly) NSArray<AquisitoCorePromotionGalleryImageDto *> *gallery __attribute__((swift_name("gallery")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
...
@property (readonly) AquisitoCoreInt * _Nullable max_redemptions __attribute__((swift_name("max_redemptions")));
@property (readonly) AquisitoCoreInt * _Nullable max_redemptions_per_user __attribute__((swift_name("max_redemptions_per_user")));
@property (readonly) NSString * _Nullable price __attribute__((swift_name("price")));
@property (readonly) int32_t redeem_count __attribute__((swift_name("redeem_count")));
@property (readonly) NSString * _Nullable redeem_steps __attribute__((swift_name("redeem_steps")));
@property (readonly) NSString *redeem_type __attribute__((swift_name("redeem_type")));
@property (readonly) NSString * _Nullable short_description __attribute__((swift_name("short_description")));
@property (readonly) NSString *status __attribute__((swift_name("status")));
@property (readonly) NSString * _Nullable terms_and_conditions __attribute__((swift_name("terms_and_conditions")));
...
@property (readonly) NSString *visible_from __attribute__((swift_name("visible_from")));
@property (readonly) NSString *visible_until __attribute__((swift_name("visible_until")));
- (instancetype)initWithId:(int32_t)id uuid:(NSString *)uuid title:(NSString *)title short_description:(NSString * _Nullable)short_description description:(NSString * _Nullable)description terms_and_conditions:(NSString * _Nullable)terms_and_conditions status:(NSString *)status redeem_type:(NSString *)redeem_type is_featured:(BOOL)is_featured redeem_steps:(NSString * _Nullable)redeem_steps price:(NSString * _Nullable)price max_redemptions:(AquisitoCoreInt * _Nullable)max_redemptions redeem_count:(int32_t)redeem_count max_redemptions_per_user:(AquisitoCoreInt * _Nullable)max_redemptions_per_user expires_at:(NSString *)expires_at visible_from:(NSString *)visible_from visible_until:(NSString *)visible_until image:(NSString *)image gallery:(NSArray<AquisitoCorePromotionGalleryImageDto *> *)gallery created_at:(NSString *)created_at updated_at:(NSString *)updated_at __attribute__((swift_name("init(id:uuid:title:short_description:description:terms_and_conditions:status:redeem_type:is_featured:redeem_steps:price:max_redemptions:redeem_count:max_redemptions_per_user:expires_at:visible_from:visible_until:image:gallery:created_at:updated_at:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCorePromotionDto *)doCopyId:(int32_t)id uuid:(NSString *)uuid title:(NSString *)title short_description:(NSString * _Nullable)short_description description:(NSString * _Nullable)description terms_and_conditions:(NSString * _Nullable)terms_and_conditions status:(NSString *)status redeem_type:(NSString *)redeem_type is_featured:(BOOL)is_featured redeem_steps:(NSString * _Nullable)redeem_steps price:(NSString * _Nullable)price max_redemptions:(AquisitoCoreInt * _Nullable)max_redemptions redeem_count:(int32_t)redeem_count max_redemptions_per_user:(AquisitoCoreInt * _Nullable)max_redemptions_per_user expires_at:(NSString *)expires_at visible_from:(NSString *)visible_from visible_until:(NSString *)visible_until image:(NSString *)image gallery:(NSArray<AquisitoCorePromotionGalleryImageDto *> *)gallery created_at:(NSString *)created_at updated_at:(NSString *)updated_at __attribute__((swift_name("doCopy(id:uuid:title:short_description:description:terms_and_conditions:status:redeem_type:is_featured:redeem_steps:price:max_redemptions:redeem_count:max_redemptions_per_user:expires_at:visible_from:visible_until:image:gallery:created_at:updated_at:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionDto.Companion")))
@interface AquisitoCorePromotionDtoCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCorePromotionDtoCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AquisitoCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionGalleryImageDto")))
@interface AquisitoCorePromotionGalleryImageDto : AquisitoCoreBase
@property (class, readonly, getter=companion) AquisitoCorePromotionGalleryImageDtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) NSString *url __attribute__((swift_name("url")));
- (instancetype)initWithId:(int32_t)id url:(NSString *)url __attribute__((swift_name("init(id:url:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCorePromotionGalleryImageDto *)doCopyId:(int32_t)id url:(NSString *)url __attribute__((swift_name("doCopy(id:url:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionGalleryImageDto.Companion")))
@interface AquisitoCorePromotionGalleryImageDtoCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCorePromotionGalleryImageDtoCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AquisitoCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionRedemptionDto")))
@interface AquisitoCorePromotionRedemptionDto : AquisitoCoreBase
@property (class, readonly, getter=companion) AquisitoCorePromotionRedemptionDtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *created_at __attribute__((swift_name("created_at")));
@property (readonly) NSString *expires_at __attribute__((swift_name("expires_at")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) BOOL is_expired __attribute__((swift_name("is_expired")));
@property (readonly) AquisitoCoreSimplePromotionDto *promotion __attribute__((swift_name("promotion")));
@property (readonly) NSString *qr_code __attribute__((swift_name("qr_code")));
@property (readonly) NSString *redeemed_at __attribute__((swift_name("redeemed_at")));
@property (readonly) NSString *status __attribute__((swift_name("status")));
- (instancetype)initWithId:(int32_t)id qr_code:(NSString *)qr_code status:(NSString *)status expires_at:(NSString *)expires_at is_expired:(BOOL)is_expired redeemed_at:(NSString *)redeemed_at promotion:(AquisitoCoreSimplePromotionDto *)promotion created_at:(NSString *)created_at __attribute__((swift_name("init(id:qr_code:status:expires_at:is_expired:redeemed_at:promotion:created_at:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCorePromotionRedemptionDto *)doCopyId:(int32_t)id qr_code:(NSString *)qr_code status:(NSString *)status expires_at:(NSString *)expires_at is_expired:(BOOL)is_expired redeemed_at:(NSString *)redeemed_at promotion:(AquisitoCoreSimplePromotionDto *)promotion created_at:(NSString *)created_at __attribute__((swift_name("doCopy(id:qr_code:status:expires_at:is_expired:redeemed_at:promotion:created_at:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionRedemptionDto.Companion")))
@interface AquisitoCorePromotionRedemptionDtoCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCorePromotionRedemptionDtoCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AquisitoCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@property (readonly) AquisitoCoreInt * _Nullable ambience_rating __attribute__((swift_name("ambience_rating")));
@property (readonly) NSString * _Nullable comment __attribute__((swift_name("comment")));
@property (readonly) NSString * _Nullable created_at __attribute__((swift_name("created_at")));
@property (readonly) AquisitoCoreInt * _Nullable dislikes_count __attribute__((swift_name("dislikes_count")));
@property (readonly) AquisitoCoreInt * _Nullable food_rating __attribute__((swift_name("food_rating")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) NSArray<AquisitoCoreImageMediaDto *> *images __attribute__((swift_name("images")));
@property (readonly) AquisitoCoreBoolean * _Nullable is_featured __attribute__((swift_name("is_featured")));
@property (readonly) AquisitoCoreInt * _Nullable likes_count __attribute__((swift_name("likes_count")));
@property (readonly) int32_t overall_rating __attribute__((swift_name("overall_rating")));
@property (readonly) NSString *overall_score __attribute__((swift_name("overall_score")));
@property (readonly) AquisitoCoreInt * _Nullable price_rating __attribute__((swift_name("price_rating")));
@property (readonly) AquisitoCoreInt * _Nullable service_rating __attribute__((swift_name("service_rating")));
@property (readonly) NSString * _Nullable updated_at __attribute__((swift_name("updated_at")));
...
- (instancetype)initWithId:(int32_t)id overall_rating:(int32_t)overall_rating food_rating:(AquisitoCoreInt * _Nullable)food_rating service_rating:(AquisitoCoreInt * _Nullable)service_rating ambience_rating:(AquisitoCoreInt * _Nullable)ambience_rating price_rating:(AquisitoCoreInt * _Nullable)price_rating overall_score:(NSString *)overall_score comment:(NSString * _Nullable)comment is_featured:(AquisitoCoreBoolean * _Nullable)is_featured likes_count:(AquisitoCoreInt * _Nullable)likes_count dislikes_count:(AquisitoCoreInt * _Nullable)dislikes_count user:(AquisitoCoreUserDto * _Nullable)user user_reaction:(NSString * _Nullable)user_reaction created_at:(NSString * _Nullable)created_at updated_at:(NSString * _Nullable)updated_at images:(NSArray<AquisitoCoreImageMediaDto *> *)images __attribute__((swift_name("init(id:overall_rating:food_rating:service_rating:ambience_rating:price_rating:overall_score:comment:is_featured:likes_count:dislikes_count:user:user_reaction:created_at:updated_at:images:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreRatingDto *)doCopyId:(int32_t)id overall_rating:(int32_t)overall_rating food_rating:(AquisitoCoreInt * _Nullable)food_rating service_rating:(AquisitoCoreInt * _Nullable)service_rating ambience_rating:(AquisitoCoreInt * _Nullable)ambience_rating price_rating:(AquisitoCoreInt * _Nullable)price_rating overall_score:(NSString *)overall_score comment:(NSString * _Nullable)comment is_featured:(AquisitoCoreBoolean * _Nullable)is_featured likes_count:(AquisitoCoreInt * _Nullable)likes_count dislikes_count:(AquisitoCoreInt * _Nullable)dislikes_count user:(AquisitoCoreUserDto * _Nullable)user user_reaction:(NSString * _Nullable)user_reaction created_at:(NSString * _Nullable)created_at updated_at:(NSString * _Nullable)updated_at images:(NSArray<AquisitoCoreImageMediaDto *> *)images __attribute__((swift_name("doCopy(id:overall_rating:food_rating:service_rating:ambience_rating:price_rating:overall_score:comment:is_featured:likes_count:dislikes_count:user:user_reaction:created_at:updated_at:images:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
- (instancetype)initWithFirst_name:(NSString *)first_name last_name:(NSString *)last_name name:(NSString *)name email:(NSString *)email username:(NSString *)username phone:(NSString * _Nullable)phone password:(NSString * _Nullable)password avatar:(NSString * _Nullable)avatar social_driver:(NSString * _Nullable)social_driver social_id:(NSString * _Nullable)social_id __attribute__((swift_name("init(first_name:last_name:name:email:username:phone:password:avatar:social_driver:social_id:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreSignUpRequestDto *)doCopyFirst_name:(NSString *)first_name last_name:(NSString *)last_name name:(NSString *)name email:(NSString *)email username:(NSString *)username phone:(NSString * _Nullable)phone password:(NSString * _Nullable)password avatar:(NSString * _Nullable)avatar social_driver:(NSString * _Nullable)social_driver social_id:(NSString * _Nullable)social_id __attribute__((swift_name("doCopy(first_name:last_name:name:email:username:phone:password:avatar:social_driver:social_id:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SimplePromotionDto")))
@interface AquisitoCoreSimplePromotionDto : AquisitoCoreBase
@property (class, readonly, getter=companion) AquisitoCoreSimplePromotionDtoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString * _Nullable description_ __attribute__((swift_name("description_")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) NSString *image __attribute__((swift_name("image")));
@property (readonly) BOOL is_featured __attribute__((swift_name("is_featured")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly) NSString *reedem_type __attribute__((swift_name("reedem_type")));
@property (readonly) NSString *uuid __attribute__((swift_name("uuid")));
- (instancetype)initWithId:(int32_t)id uuid:(NSString *)uuid name:(NSString *)name description:(NSString * _Nullable)description is_featured:(BOOL)is_featured reedem_type:(NSString *)reedem_type image:(NSString *)image __attribute__((swift_name("init(id:uuid:name:description:is_featured:reedem_type:image:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreSimplePromotionDto *)doCopyId:(int32_t)id uuid:(NSString *)uuid name:(NSString *)name description:(NSString * _Nullable)description is_featured:(BOOL)is_featured reedem_type:(NSString *)reedem_type image:(NSString *)image __attribute__((swift_name("doCopy(id:uuid:name:description:is_featured:reedem_type:image:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SimplePromotionDto.Companion")))
@interface AquisitoCoreSimplePromotionDtoCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCoreSimplePromotionDtoCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AquisitoCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
@property (readonly) NSString * _Nullable social_id __attribute__((swift_name("social_id")));
- (instancetype)initWithAccess_token:(NSString * _Nullable)access_token avatar:(NSString * _Nullable)avatar email:(NSString * _Nullable)email first_name:(NSString * _Nullable)first_name last_name:(NSString * _Nullable)last_name name:(NSString * _Nullable)name social_id:(NSString * _Nullable)social_id __attribute__((swift_name("init(access_token:avatar:email:first_name:last_name:name:social_id:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreSocialLoginDataDto *)doCopyAccess_token:(NSString * _Nullable)access_token avatar:(NSString * _Nullable)avatar email:(NSString * _Nullable)email first_name:(NSString * _Nullable)first_name last_name:(NSString * _Nullable)last_name name:(NSString * _Nullable)name social_id:(NSString * _Nullable)social_id __attribute__((swift_name("doCopy(access_token:avatar:email:first_name:last_name:name:social_id:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@property (readonly) NSString * _Nullable avatar __attribute__((swift_name("avatar")));
@property (readonly) NSString * _Nullable birth_date __attribute__((swift_name("birth_date")));
@property (readonly) NSString * _Nullable created_at __attribute__((swift_name("created_at")));
@property (readonly) NSString * _Nullable email __attribute__((swift_name("email")));
...
- (instancetype)initWithId:(int32_t)id first_name:(NSString * _Nullable)first_name last_name:(NSString * _Nullable)last_name name:(NSString *)name email:(NSString * _Nullable)email username:(NSString * _Nullable)username email_verified_at:(NSString * _Nullable)email_verified_at phone:(NSString * _Nullable)phone birth_date:(NSString * _Nullable)birth_date avatar:(NSString * _Nullable)avatar created_at:(NSString * _Nullable)created_at updated_at:(NSString * _Nullable)updated_at __attribute__((swift_name("init(id:first_name:last_name:name:email:username:email_verified_at:phone:birth_date:avatar:created_at:updated_at:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreUserDto *)doCopyId:(int32_t)id first_name:(NSString * _Nullable)first_name last_name:(NSString * _Nullable)last_name name:(NSString *)name email:(NSString * _Nullable)email username:(NSString * _Nullable)username email_verified_at:(NSString * _Nullable)email_verified_at phone:(NSString * _Nullable)phone birth_date:(NSString * _Nullable)birth_date avatar:(NSString * _Nullable)avatar created_at:(NSString * _Nullable)created_at updated_at:(NSString * _Nullable)updated_at __attribute__((swift_name("doCopy(id:first_name:last_name:name:email:username:email_verified_at:phone:birth_date:avatar:created_at:updated_at:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiConstant.Promotion")))
@interface AquisitoCoreApiConstantPromotion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCoreApiConstantPromotion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)promotion __attribute__((swift_name("init()")));
- (NSString *)getPlacePromotionsPlaceSlug:(NSString *)placeSlug __attribute__((swift_name("getPlacePromotions(placeSlug:)")));
- (NSString *)getPromotionDetailPlaceSlug:(NSString *)placeSlug promotionUuid:(NSString *)promotionUuid __attribute__((swift_name("getPromotionDetail(placeSlug:promotionUuid:)")));
- (NSString *)redeemPromotionPromotionUuid:(NSString *)promotionUuid __attribute__((swift_name("redeemPromotion(promotionUuid:)")));
@end
...
@property (readonly) NSString *UPDATE_PASSWORD __attribute__((swift_name("UPDATE_PASSWORD")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)updatePasswordRequest:(AquisitoCoreUpdatePasswordRequestDto *)request completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("updatePassword(request:completionHandler:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionApi")))
@interface AquisitoCorePromotionApi : AquisitoCoreBase
- (instancetype)initWithClient:(AquisitoCoreKtor_client_coreHttpClient *)client __attribute__((swift_name("init(client:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPlacePromotionsPlaceSlug:(NSString *)placeSlug completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getPlacePromotions(placeSlug:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPromotionDetailPlaceSlug:(NSString *)placeSlug promotionUuid:(NSString *)promotionUuid completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getPromotionDetail(placeSlug:promotionUuid:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)redeemPromotionPromotionUuid:(NSString *)promotionUuid completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("redeemPromotion(promotionUuid:completionHandler:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)upsertRatingSlug:(NSString *)slug overallRating:(int32_t)overallRating foodRating:(AquisitoCoreInt * _Nullable)foodRating serviceRating:(AquisitoCoreInt * _Nullable)serviceRating ambienceRating:(AquisitoCoreInt * _Nullable)ambienceRating priceRating:(AquisitoCoreInt * _Nullable)priceRating comment:(NSString * _Nullable)comment images:(NSArray<AquisitoCoreKmpFile *> *)images completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("upsertRating(slug:overallRating:foodRating:serviceRating:ambienceRating:priceRating:comment:images:completionHandler:)")));
@end
...
- (id<AquisitoCoreKotlinx_coroutines_coreFlow>)getUserCollections __attribute__((swift_name("getUserCollections()")));
...
- (instancetype)initWithApi:(AquisitoCoreCollectionApi *)api dao:(id<AquisitoCoreCollectionDao>)dao __attribute__((swift_name("init(api:dao:)"))) __attribute__((objc_designated_initializer));
...
@protocol AquisitoCorePromotionRepository
@required
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionRepositoryImpl")))
@interface AquisitoCorePromotionRepositoryImpl : AquisitoCoreBase <AquisitoCorePromotionRepository>
- (instancetype)initWithApi:(AquisitoCorePromotionApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) NSString *address __attribute__((swift_name("address")));
@property (readonly) NSString * _Nullable ambienceAvgScore __attribute__((swift_name("ambienceAvgScore")));
...
@property (readonly) NSArray<AquisitoCoreLink *> *deliveryLinks __attribute__((swift_name("deliveryLinks")));
@property (readonly) AquisitoCoreDepartment *department __attribute__((swift_name("department")));
@property (readonly) NSString *description_ __attribute__((swift_name("description_")));
@property (readonly) AquisitoCoreDistrict *district __attribute__((swift_name("district")));
@property (readonly) BOOL featured __attribute__((swift_name("featured")));
@property (readonly) NSString * _Nullable foodAvgScore __attribute__((swift_name("foodAvgScore")));
@property (readonly) NSArray<NSString *> *gallery __attribute__((swift_name("gallery")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) AquisitoCoreBoolean * _Nullable isFavorite __attribute__((swift_name("isFavorite")));
@property (readonly) double latitude __attribute__((swift_name("latitude")));
...
@property (readonly) NSString * _Nullable priceAvgScore __attribute__((swift_name("priceAvgScore")));
...
@property (readonly) NSString * _Nullable serviceAvgScore __attribute__((swift_name("serviceAvgScore")));
@property (readonly) NSString *slug __attribute__((swift_name("slug")));
...
@interface AquisitoCorePromotion : AquisitoCoreBase
@property (readonly) NSString *createdAt __attribute__((swift_name("createdAt")));
@property (readonly) NSString * _Nullable description_ __attribute__((swift_name("description_")));
@property (readonly) NSString *expiresAt __attribute__((swift_name("expiresAt")));
@property (readonly) NSArray<AquisitoCorePromotionGalleryImage *> *gallery __attribute__((swift_name("gallery")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) NSString *image __attribute__((swift_name("image")));
@property (readonly) BOOL isFeatured __attribute__((swift_name("isFeatured")));
@property (readonly) AquisitoCoreInt * _Nullable maxRedemptions __attribute__((swift_name("maxRedemptions")));
@property (readonly) AquisitoCoreInt * _Nullable maxRedemptionsPerUser __attribute__((swift_name("maxRedemptionsPerUser")));
@property (readonly) NSString * _Nullable price __attribute__((swift_name("price")));
@property (readonly) int32_t redeemCount __attribute__((swift_name("redeemCount")));
@property (readonly) NSString * _Nullable redeemSteps __attribute__((swift_name("redeemSteps")));
@property (readonly) NSString *redeemType __attribute__((swift_name("redeemType")));
...
@property (readonly) NSString *updatedAt __attribute__((swift_name("updatedAt")));
@property (readonly) NSString *uuid __attribute__((swift_name("uuid")));
@property (readonly) NSString *visibleFrom __attribute__((swift_name("visibleFrom")));
@property (readonly) NSString *visibleUntil __attribute__((swift_name("visibleUntil")));
- (instancetype)initWithId:(int32_t)id uuid:(NSString *)uuid title:(NSString *)title shortDescription:(NSString * _Nullable)shortDescription description:(NSString * _Nullable)description termsAndConditions:(NSString * _Nullable)termsAndConditions status:(NSString *)status redeemType:(NSString *)redeemType isFeatured:(BOOL)isFeatured redeemSteps:(NSString * _Nullable)redeemSteps price:(NSString * _Nullable)price maxRedemptions:(AquisitoCoreInt * _Nullable)maxRedemptions redeemCount:(int32_t)redeemCount maxRedemptionsPerUser:(AquisitoCoreInt * _Nullable)maxRedemptionsPerUser expiresAt:(NSString *)expiresAt visibleFrom:(NSString *)visibleFrom visibleUntil:(NSString *)visibleUntil image:(NSString *)image gallery:(NSArray<AquisitoCorePromotionGalleryImage *> *)gallery createdAt:(NSString *)createdAt updatedAt:(NSString *)updatedAt __attribute__((swift_name("init(id:uuid:title:shortDescription:description:termsAndConditions:status:redeemType:isFeatured:redeemSteps:price:maxRedemptions:redeemCount:maxRedemptionsPerUser:expiresAt:visibleFrom:visibleUntil:image:gallery:createdAt:updatedAt:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCorePromotion *)doCopyId:(int32_t)id uuid:(NSString *)uuid title:(NSString *)title shortDescription:(NSString * _Nullable)shortDescription description:(NSString * _Nullable)description termsAndConditions:(NSString * _Nullable)termsAndConditions status:(NSString *)status redeemType:(NSString *)redeemType isFeatured:(BOOL)isFeatured redeemSteps:(NSString * _Nullable)redeemSteps price:(NSString * _Nullable)price maxRedemptions:(AquisitoCoreInt * _Nullable)maxRedemptions redeemCount:(int32_t)redeemCount maxRedemptionsPerUser:(AquisitoCoreInt * _Nullable)maxRedemptionsPerUser expiresAt:(NSString *)expiresAt visibleFrom:(NSString *)visibleFrom visibleUntil:(NSString *)visibleUntil image:(NSString *)image gallery:(NSArray<AquisitoCorePromotionGalleryImage *> *)gallery createdAt:(NSString *)createdAt updatedAt:(NSString *)updatedAt __attribute__((swift_name("doCopy(id:uuid:title:shortDescription:description:termsAndConditions:status:redeemType:isFeatured:redeemSteps:price:maxRedemptions:redeemCount:maxRedemptionsPerUser:expiresAt:visibleFrom:visibleUntil:image:gallery:createdAt:updatedAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionGalleryImage")))
@interface AquisitoCorePromotionGalleryImage : AquisitoCoreBase
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) NSString *url __attribute__((swift_name("url")));
- (instancetype)initWithId:(int32_t)id url:(NSString *)url __attribute__((swift_name("init(id:url:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCorePromotionGalleryImage *)doCopyId:(int32_t)id url:(NSString *)url __attribute__((swift_name("doCopy(id:url:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionRedemption")))
@interface AquisitoCorePromotionRedemption : AquisitoCoreBase
@property (readonly) NSString *createdAt __attribute__((swift_name("createdAt")));
@property (readonly) NSString *expiresAt __attribute__((swift_name("expiresAt")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) BOOL isExpired __attribute__((swift_name("isExpired")));
@property (readonly) AquisitoCoreSimplePromotion *promotion __attribute__((swift_name("promotion")));
...
@property (readonly) NSString *status __attribute__((swift_name("status")));
- (instancetype)initWithId:(int32_t)id qrCode:(NSString *)qrCode status:(NSString *)status expiresAt:(NSString *)expiresAt isExpired:(BOOL)isExpired redeemedAt:(NSString *)redeemedAt promotion:(AquisitoCoreSimplePromotion *)promotion createdAt:(NSString *)createdAt __attribute__((swift_name("init(id:qrCode:status:expiresAt:isExpired:redeemedAt:promotion:createdAt:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCorePromotionRedemption *)doCopyId:(int32_t)id qrCode:(NSString *)qrCode status:(NSString *)status expiresAt:(NSString *)expiresAt isExpired:(BOOL)isExpired redeemedAt:(NSString *)redeemedAt promotion:(AquisitoCoreSimplePromotion *)promotion createdAt:(NSString *)createdAt __attribute__((swift_name("doCopy(id:qrCode:status:expiresAt:isExpired:redeemedAt:promotion:createdAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@property (readonly) AquisitoCoreInt * _Nullable ambienceRating __attribute__((swift_name("ambienceRating")));
@property (readonly) NSString * _Nullable comment __attribute__((swift_name("comment")));
@property (readonly) NSString * _Nullable createdAt __attribute__((swift_name("createdAt")));
@property (readonly) int32_t dislikesCount __attribute__((swift_name("dislikesCount")));
@property (readonly) AquisitoCoreInt * _Nullable foodRating __attribute__((swift_name("foodRating")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
...
@property (readonly) int32_t overallRating __attribute__((swift_name("overallRating")));
@property (readonly) NSString *overallScore __attribute__((swift_name("overallScore")));
@property (readonly) AquisitoCoreInt * _Nullable priceRating __attribute__((swift_name("priceRating")));
@property (readonly) AquisitoCoreInt * _Nullable serviceRating __attribute__((swift_name("serviceRating")));
...
- (instancetype)initWithOverallRating:(int32_t)overallRating foodRating:(AquisitoCoreInt * _Nullable)foodRating serviceRating:(AquisitoCoreInt * _Nullable)serviceRating ambienceRating:(AquisitoCoreInt * _Nullable)ambienceRating priceRating:(AquisitoCoreInt * _Nullable)priceRating comment:(NSString * _Nullable)comment __attribute__((swift_name("init(overallRating:foodRating:serviceRating:ambienceRating:priceRating:comment:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithId:(int32_t)id overallRating:(int32_t)overallRating foodRating:(AquisitoCoreInt * _Nullable)foodRating serviceRating:(AquisitoCoreInt * _Nullable)serviceRating ambienceRating:(AquisitoCoreInt * _Nullable)ambienceRating priceRating:(AquisitoCoreInt * _Nullable)priceRating overallScore:(NSString *)overallScore comment:(NSString * _Nullable)comment isFeatured:(BOOL)isFeatured likesCount:(int32_t)likesCount dislikesCount:(int32_t)dislikesCount images:(NSArray<AquisitoCoreImageMedia *> *)images user:(AquisitoCoreUser * _Nullable)user userReaction:(NSString * _Nullable)userReaction createdAt:(NSString * _Nullable)createdAt updatedAt:(NSString * _Nullable)updatedAt __attribute__((swift_name("init(id:overallRating:foodRating:serviceRating:ambienceRating:priceRating:overallScore:comment:isFeatured:likesCount:dislikesCount:images:user:userReaction:createdAt:updatedAt:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreRating *)doCopyId:(int32_t)id overallRating:(int32_t)overallRating foodRating:(AquisitoCoreInt * _Nullable)foodRating serviceRating:(AquisitoCoreInt * _Nullable)serviceRating ambienceRating:(AquisitoCoreInt * _Nullable)ambienceRating priceRating:(AquisitoCoreInt * _Nullable)priceRating overallScore:(NSString *)overallScore comment:(NSString * _Nullable)comment isFeatured:(BOOL)isFeatured likesCount:(int32_t)likesCount dislikesCount:(int32_t)dislikesCount images:(NSArray<AquisitoCoreImageMedia *> *)images user:(AquisitoCoreUser * _Nullable)user userReaction:(NSString * _Nullable)userReaction createdAt:(NSString * _Nullable)createdAt updatedAt:(NSString * _Nullable)updatedAt __attribute__((swift_name("doCopy(id:overallRating:foodRating:serviceRating:ambienceRating:priceRating:overallScore:comment:isFeatured:likesCount:dislikesCount:images:user:userReaction:createdAt:updatedAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SimplePromotion")))
@interface AquisitoCoreSimplePromotion : AquisitoCoreBase
@property (readonly) NSString * _Nullable description_ __attribute__((swift_name("description_")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) NSString *image __attribute__((swift_name("image")));
@property (readonly) BOOL isFeatured __attribute__((swift_name("isFeatured")));
...
@property (readonly) NSString *redeemType __attribute__((swift_name("redeemType")));
@property (readonly) NSString *uuid __attribute__((swift_name("uuid")));
- (instancetype)initWithId:(int32_t)id uuid:(NSString *)uuid name:(NSString *)name description:(NSString * _Nullable)description isFeatured:(BOOL)isFeatured redeemType:(NSString *)redeemType image:(NSString *)image __attribute__((swift_name("init(id:uuid:name:description:isFeatured:redeemType:image:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreSimplePromotion *)doCopyId:(int32_t)id uuid:(NSString *)uuid name:(NSString *)name description:(NSString * _Nullable)description isFeatured:(BOOL)isFeatured redeemType:(NSString *)redeemType image:(NSString *)image __attribute__((swift_name("doCopy(id:uuid:name:description:isFeatured:redeemType:image:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
- (instancetype)initWithAccessToken:(NSString *)accessToken message:(NSString *)message avatar:(NSString * _Nullable)avatar email:(NSString * _Nullable)email firstName:(NSString * _Nullable)firstName lastName:(NSString * _Nullable)lastName name:(NSString * _Nullable)name socialId:(NSString * _Nullable)socialId isRegistered:(BOOL)isRegistered __attribute__((swift_name("init(accessToken:message:avatar:email:firstName:lastName:name:socialId:isRegistered:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreSocialLoginResult *)doCopyAccessToken:(NSString *)accessToken message:(NSString *)message avatar:(NSString * _Nullable)avatar email:(NSString * _Nullable)email firstName:(NSString * _Nullable)firstName lastName:(NSString * _Nullable)lastName name:(NSString * _Nullable)name socialId:(NSString * _Nullable)socialId isRegistered:(BOOL)isRegistered __attribute__((swift_name("doCopy(accessToken:message:avatar:email:firstName:lastName:name:socialId:isRegistered:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@property (readonly) NSString *updatedAt __attribute__((swift_name("updatedAt")));
@property (readonly) NSString *username __attribute__((swift_name("username")));
- (instancetype)initWithId:(int32_t)id firstName:(NSString *)firstName lastName:(NSString *)lastName name:(NSString *)name email:(NSString *)email username:(NSString *)username emailVerifiedAt:(NSString * _Nullable)emailVerifiedAt phone:(NSString *)phone birthDate:(NSString * _Nullable)birthDate avatar:(NSString * _Nullable)avatar createdAt:(NSString *)createdAt updatedAt:(NSString *)updatedAt __attribute__((swift_name("init(id:firstName:lastName:name:email:username:emailVerifiedAt:phone:birthDate:avatar:createdAt:updatedAt:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreUser *)doCopyId:(int32_t)id firstName:(NSString *)firstName lastName:(NSString *)lastName name:(NSString *)name email:(NSString *)email username:(NSString *)username emailVerifiedAt:(NSString * _Nullable)emailVerifiedAt phone:(NSString *)phone birthDate:(NSString * _Nullable)birthDate avatar:(NSString * _Nullable)avatar createdAt:(NSString *)createdAt updatedAt:(NSString *)updatedAt __attribute__((swift_name("doCopy(id:firstName:lastName:name:email:username:emailVerifiedAt:phone:birthDate:avatar:createdAt:updatedAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)signUpFirstName:(NSString *)firstName lastName:(NSString *)lastName name:(NSString *)name email:(NSString *)email username:(NSString *)username phone:(NSString * _Nullable)phone password:(NSString * _Nullable)password avatar:(NSString * _Nullable)avatar socialDriver:(NSString * _Nullable)socialDriver socialId:(NSString * _Nullable)socialId completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("signUp(firstName:lastName:name:email:username:phone:password:avatar:socialDriver:socialId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)updatePasswordCurrentPassword:(NSString *)currentPassword password:(NSString *)password passwordConfirmation:(NSString *)passwordConfirmation completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("updatePassword(currentPassword:password:passwordConfirmation:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)updateUserProfileFirstName:(NSString *)firstName lastName:(NSString *)lastName email:(NSString *)email birthDate:(NSString *)birthDate phone:(NSString *)phone completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("updateUserProfile(firstName:lastName:email:birthDate:phone:completionHandler:)")));
@end
...
@property (class, readonly, getter=shared) AquisitoCoreAuthEventLoggedIn *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)loggedIn __attribute__((swift_name("init()")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)notifyLoggedInWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("notifyLoggedIn(completionHandler:)")));
...
@property (readonly) id<AquisitoCoreKotlinx_coroutines_coreSharedFlow> eventsFlow __attribute__((swift_name("eventsFlow")));
- (instancetype)initWithLocalDataSource:(id<AquisitoCoreAuthLocalDataSource>)localDataSource appDatabase:(AquisitoCoreAppDatabase *)appDatabase __attribute__((swift_name("init(localDataSource:appDatabase:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokeFirstName:(NSString *)firstName lastName:(NSString *)lastName name:(NSString *)name email:(NSString *)email username:(NSString *)username phone:(NSString * _Nullable)phone password:(NSString * _Nullable)password avatar:(NSString * _Nullable)avatar socialDriver:(NSString * _Nullable)socialDriver socialId:(NSString * _Nullable)socialId completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(firstName:lastName:name:email:username:phone:password:avatar:socialDriver:socialId:completionHandler:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UpdatePasswordUseCase")))
@interface AquisitoCoreUpdatePasswordUseCase : AquisitoCoreBase
- (instancetype)initWithRepository:(id<AquisitoCoreAuthRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokeCurrentPassword:(NSString *)currentPassword password:(NSString *)password passwordConfirmation:(NSString *)passwordConfirmation completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(currentPassword:password:passwordConfirmation:completionHandler:)")));
@end
...
- (instancetype)initWithRepository:(id<AquisitoCoreCollectionRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
- (id<AquisitoCoreKotlinx_coroutines_coreFlow>)invoke __attribute__((swift_name("invoke()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetPromotionDetailUseCase")))
@interface AquisitoCoreGetPromotionDetailUseCase : AquisitoCoreBase
- (instancetype)initWithRepository:(id<AquisitoCorePromotionRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokePlaceSlug:(NSString *)placeSlug promotionUuid:(NSString *)promotionUuid completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(placeSlug:promotionUuid:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListPlacePromotionsUseCase")))
@interface AquisitoCoreListPlacePromotionsUseCase : AquisitoCoreBase
- (instancetype)initWithRepository:(id<AquisitoCorePromotionRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokePlaceSlug:(NSString *)placeSlug completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(placeSlug:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RedeemPromotionUseCase")))
@interface AquisitoCoreRedeemPromotionUseCase : AquisitoCoreBase
- (instancetype)initWithRepository:(id<AquisitoCorePromotionRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokePromotionUuid:(NSString *)promotionUuid completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(promotionUuid:completionHandler:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokeSlug:(NSString *)slug overallRating:(int32_t)overallRating foodRating:(AquisitoCoreInt * _Nullable)foodRating serviceRating:(AquisitoCoreInt * _Nullable)serviceRating ambienceRating:(AquisitoCoreInt * _Nullable)ambienceRating priceRating:(AquisitoCoreInt * _Nullable)priceRating comment:(NSString * _Nullable)comment images:(NSArray<AquisitoCoreKmpFile *> *)images completionHandler:(void (^)(id<AquisitoCoreResultViewState> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(slug:overallRating:foodRating:serviceRating:ambienceRating:priceRating:comment:images:completionHandler:)")));
@end
...
@interface AquisitoCoreUpdateUserProfileUseCase : AquisitoCoreBase
- (instancetype)initWithRepository:(id<AquisitoCoreUserRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
...
@interface AquisitoCoreCollectionEntity (Extensions)
...
- (AquisitoCoreCollection *)toDomain __attribute__((swift_name("toDomain()")));
- (AquisitoCoreCollectionEntity *)toEntity __attribute__((swift_name("toEntity()")));
@end
...
@interface AquisitoCorePromotionDto (Extensions)
- (AquisitoCorePromotion *)toDomain __attribute__((swift_name("toDomain()")));
@end

@interface AquisitoCorePromotionGalleryImageDto (Extensions)
- (AquisitoCorePromotionGalleryImage *)toDomain __attribute__((swift_name("toDomain()")));
@end

@interface AquisitoCorePromotionRedemptionDto (Extensions)
- (AquisitoCorePromotionRedemption *)toDomain __attribute__((swift_name("toDomain()")));
@end
...
@interface AquisitoCoreSimplePromotionDto (Extensions)
- (AquisitoCoreSimplePromotion *)toDomain __attribute__((swift_name("toDomain()")));
@end
...
@interface AquisitoCoreDatabaseBuilder_iosKt : AquisitoCoreBase
+ (AquisitoCoreAppDatabase *)createDatabaseContext:(AquisitoCorePlatformContext *)context __attribute__((swift_name("createDatabase(context:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PromotionModuleKt")))
@interface AquisitoCorePromotionModuleKt : AquisitoCoreBase
@property (class, readonly) AquisitoCoreKoin_coreModule *promotionModule __attribute__((swift_name("promotionModule")));
@end
...
@interface AquisitoCore__SkieSuspendWrappersKt : AquisitoCoreBase
+ (void)Skie_Suspend__0__hasNextDispatchReceiver:(AquisitoCoreSkieColdFlowIterator<id> *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__0__hasNext(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__100__readFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(AquisitoCoreKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__100__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__101__readFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__101__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__102__readFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int64_t)offset length:(int64_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__102__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__103__readIntDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__103__readInt(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__104__readLongDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__104__readLong(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__105__readPacketDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver size:(int32_t)size suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__105__readPacket(dispatchReceiver:size:suspendHandler:)")));
+ (void)Skie_Suspend__106__readRemainingDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver limit:(int64_t)limit suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__106__readRemaining(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__107__readShortDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__107__readShort(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__108__readSuspendableSessionDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver consumer:(id<AquisitoCoreKotlinSuspendFunction1>)consumer suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__108__readSuspendableSession(dispatchReceiver:consumer:suspendHandler:)")));
+ (void)Skie_Suspend__109__readUTF8LineDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver limit:(int32_t)limit suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__109__readUTF8Line(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__10__signUpDispatchReceiver:(id<AquisitoCoreAuthRepository>)dispatchReceiver firstName:(NSString *)firstName lastName:(NSString *)lastName name:(NSString *)name email:(NSString *)email username:(NSString *)username phone:(NSString * _Nullable)phone password:(NSString * _Nullable)password avatar:(NSString * _Nullable)avatar socialDriver:(NSString * _Nullable)socialDriver socialId:(NSString * _Nullable)socialId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__10__signUp(dispatchReceiver:firstName:lastName:name:email:username:phone:password:avatar:socialDriver:socialId:suspendHandler:)")));
+ (void)Skie_Suspend__110__readUTF8LineToDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver out:(id<AquisitoCoreKotlinAppendable>)out limit:(int32_t)limit suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__110__readUTF8LineTo(dispatchReceiver:out:limit:suspendHandler:)")));
+ (void)Skie_Suspend__111__invokeDispatchReceiver:(id<AquisitoCoreKotlinSuspendFunction1>)dispatchReceiver p1:(id _Nullable)p1 suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__111__invoke(dispatchReceiver:p1:suspendHandler:)")));
+ (void)Skie_Suspend__112__clearCollectionsDispatchReceiver:(id<AquisitoCoreCollectionDao>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__112__clearCollections(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__113__insertCollectionsDispatchReceiver:(id<AquisitoCoreCollectionDao>)dispatchReceiver collections:(NSArray<AquisitoCoreCollectionEntity *> *)collections suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__113__insertCollections(dispatchReceiver:collections:suspendHandler:)")));
+ (void)Skie_Suspend__114__refreshDispatchReceiver:(AquisitoCoreRoom_runtimeInvalidationTracker *)dispatchReceiver tables:(AquisitoCoreKotlinArray<NSString *> *)tables suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__114__refresh(dispatchReceiver:tables:suspendHandler:)")));
+ (void)Skie_Suspend__115__clearAccessTokenDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__115__clearAccessToken(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__116__clearUserDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__116__clearUser(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__117__getAccessTokenDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__117__getAccessToken(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__118__getUserDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__118__getUser(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__119__saveAccessTokenDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver token:(NSString *)token suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__119__saveAccessToken(dispatchReceiver:token:suspendHandler:)")));
+ (void)Skie_Suspend__11__updatePasswordDispatchReceiver:(id<AquisitoCoreAuthRepository>)dispatchReceiver currentPassword:(NSString *)currentPassword password:(NSString *)password passwordConfirmation:(NSString *)passwordConfirmation suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__11__updatePassword(dispatchReceiver:currentPassword:password:passwordConfirmation:suspendHandler:)")));
+ (void)Skie_Suspend__120__saveUserDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver userJson:(NSString *)userJson suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__120__saveUser(dispatchReceiver:userJson:suspendHandler:)")));
+ (void)Skie_Suspend__121__clearDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__121__clear(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__122__getBooleanDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver key:(NSString *)key defaultValue:(BOOL)defaultValue suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__122__getBoolean(dispatchReceiver:key:defaultValue:suspendHandler:)")));
+ (void)Skie_Suspend__123__getStringDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver key:(NSString *)key suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__123__getString(dispatchReceiver:key:suspendHandler:)")));
+ (void)Skie_Suspend__124__putBooleanDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver key:(NSString *)key value:(BOOL)value suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__124__putBoolean(dispatchReceiver:key:value:suspendHandler:)")));
+ (void)Skie_Suspend__125__putStringDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver key:(NSString *)key value:(NSString *)value suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__125__putString(dispatchReceiver:key:value:suspendHandler:)")));
+ (void)Skie_Suspend__126__removeDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver key:(NSString *)key suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__126__remove(dispatchReceiver:key:suspendHandler:)")));
+ (void)Skie_Suspend__127__clearSelectedDispatchReceiver:(id<AquisitoCoreLocationStorage>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__127__clearSelected(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__128__getSelectedDistrictDispatchReceiver:(id<AquisitoCoreLocationStorage>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__128__getSelectedDistrict(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__129__setSelectedDispatchReceiver:(id<AquisitoCoreLocationStorage>)dispatchReceiver district:(AquisitoCoreDistrict *)district suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__129__setSelected(dispatchReceiver:district:suspendHandler:)")));
+ (void)Skie_Suspend__12__verifyCodeDispatchReceiver:(id<AquisitoCoreAuthRepository>)dispatchReceiver email:(NSString *)email code:(NSString *)code suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__12__verifyCode(dispatchReceiver:email:code:suspendHandler:)")));
+ (void)Skie_Suspend__130__getAvailableAreaByLocationDispatchReceiver:(AquisitoCoreAreaApi *)dispatchReceiver request:(AquisitoCoreLatLongRequest *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__130__getAvailableAreaByLocation(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__131__getAvailableAreasDispatchReceiver:(AquisitoCoreAreaApi *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__131__getAvailableAreas(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__132__deleteAccountDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__132__deleteAccount(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__133__forgotPasswordDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreForgotPasswordRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__133__forgotPassword(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__134__loginDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreLoginRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__134__login(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__135__loginSocialDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreSocialLoginRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__135__loginSocial(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__136__logoutDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__136__logout(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__137__resetPasswordDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreResetPasswordRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__137__resetPassword(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__138__signUpDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreSignUpRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__138__signUp(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__139__updatePasswordDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreUpdatePasswordRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__139__updatePassword(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__13__invokeDispatchReceiver:(AquisitoCoreUpsertRatingUseCase *)dispatchReceiver slug:(NSString *)slug overallRating:(int32_t)overallRating foodRating:(AquisitoCoreInt * _Nullable)foodRating serviceRating:(AquisitoCoreInt * _Nullable)serviceRating ambienceRating:(AquisitoCoreInt * _Nullable)ambienceRating priceRating:(AquisitoCoreInt * _Nullable)priceRating comment:(NSString * _Nullable)comment images:(NSArray<AquisitoCoreKmpFile *> *)images suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__13__invoke(dispatchReceiver:slug:overallRating:foodRating:serviceRating:ambienceRating:priceRating:comment:images:suspendHandler:)")));
+ (void)Skie_Suspend__140__verifyCodeDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreVerifyCodeRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__140__verifyCode(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__141__getCartDetailDispatchReceiver:(AquisitoCoreCartApi *)dispatchReceiver slug:(NSString *)slug id:(int32_t)id suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__141__getCartDetail(dispatchReceiver:slug:id:suspendHandler:)")));
+ (void)Skie_Suspend__142__addPlaceToCollectionDispatchReceiver:(AquisitoCoreCollectionApi *)dispatchReceiver collectionSlug:(NSString *)collectionSlug placeId:(int32_t)placeId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__142__addPlaceToCollection(dispatchReceiver:collectionSlug:placeId:suspendHandler:)")));
+ (void)Skie_Suspend__143__createCollectionDispatchReceiver:(AquisitoCoreCollectionApi *)dispatchReceiver request:(AquisitoCoreCreateCollectionRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__143__createCollection(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__144__getCollectionDispatchReceiver:(AquisitoCoreCollectionApi *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__144__getCollection(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__145__removeCollectionDispatchReceiver:(AquisitoCoreCollectionApi *)dispatchReceiver collectionSlug:(NSString *)collectionSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__145__removeCollection(dispatchReceiver:collectionSlug:suspendHandler:)")));
+ (void)Skie_Suspend__146__removePlaceFromCollectionDispatchReceiver:(AquisitoCoreCollectionApi *)dispatchReceiver collectionSlug:(NSString *)collectionSlug placeSlug:(NSString *)placeSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__146__removePlaceFromCollection(dispatchReceiver:collectionSlug:placeSlug:suspendHandler:)")));
+ (void)Skie_Suspend__147__parseErrorDispatchReceiver:(AquisitoCoreErrorHandler *)dispatchReceiver exception:(AquisitoCoreKotlinException *)exception suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__147__parseError(dispatchReceiver:exception:suspendHandler:)")));
+ (void)Skie_Suspend__148__getPlaceDetailDispatchReceiver:(AquisitoCorePlaceApi *)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__148__getPlaceDetail(dispatchReceiver:slug:suspendHandler:)")));
+ (void)Skie_Suspend__149__getPlacesDispatchReceiver:(AquisitoCorePlaceApi *)dispatchReceiver query:(NSDictionary<NSString *, NSString *> *)query suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__149__getPlaces(dispatchReceiver:query:suspendHandler:)")));
+ (void)Skie_Suspend__14__getListRatingsDispatchReceiver:(id<AquisitoCoreRatingPlaceRepository>)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__14__getListRatings(dispatchReceiver:slug:suspendHandler:)")));
+ (void)Skie_Suspend__150__getPlacePromotionsDispatchReceiver:(AquisitoCorePromotionApi *)dispatchReceiver placeSlug:(NSString *)placeSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__150__getPlacePromotions(dispatchReceiver:placeSlug:suspendHandler:)")));
+ (void)Skie_Suspend__151__getPromotionDetailDispatchReceiver:(AquisitoCorePromotionApi *)dispatchReceiver placeSlug:(NSString *)placeSlug promotionUuid:(NSString *)promotionUuid suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__151__getPromotionDetail(dispatchReceiver:placeSlug:promotionUuid:suspendHandler:)")));
+ (void)Skie_Suspend__152__redeemPromotionDispatchReceiver:(AquisitoCorePromotionApi *)dispatchReceiver promotionUuid:(NSString *)promotionUuid suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__152__redeemPromotion(dispatchReceiver:promotionUuid:suspendHandler:)")));
+ (void)Skie_Suspend__153__getListRatingDispatchReceiver:(AquisitoCoreRatingPlaceApi *)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__153__getListRating(dispatchReceiver:slug:suspendHandler:)")));
+ (void)Skie_Suspend__154__reactToRatingDispatchReceiver:(AquisitoCoreRatingPlaceApi *)dispatchReceiver ratingId:(int32_t)ratingId reactionType:(NSString *)reactionType suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__154__reactToRating(dispatchReceiver:ratingId:reactionType:suspendHandler:)")));
+ (void)Skie_Suspend__155__removeReactionDispatchReceiver:(AquisitoCoreRatingPlaceApi *)dispatchReceiver ratingId:(int32_t)ratingId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__155__removeReaction(dispatchReceiver:ratingId:suspendHandler:)")));
+ (void)Skie_Suspend__156__upsertRatingDispatchReceiver:(AquisitoCoreRatingPlaceApi *)dispatchReceiver slug:(NSString *)slug overallRating:(int32_t)overallRating foodRating:(AquisitoCoreInt * _Nullable)foodRating serviceRating:(AquisitoCoreInt * _Nullable)serviceRating ambienceRating:(AquisitoCoreInt * _Nullable)ambienceRating priceRating:(AquisitoCoreInt * _Nullable)priceRating comment:(NSString * _Nullable)comment images:(NSArray<AquisitoCoreKmpFile *> *)images suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__156__upsertRating(dispatchReceiver:slug:overallRating:foodRating:serviceRating:ambienceRating:priceRating:comment:images:suspendHandler:)")));
+ (void)Skie_Suspend__157__upgradeDispatchReceiver:(AquisitoCoreKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<AquisitoCoreKtor_ioByteReadChannel>)input output:(id<AquisitoCoreKtor_ioByteWriteChannel>)output engineContext:(id<AquisitoCoreKotlinCoroutineContext>)engineContext userContext:(id<AquisitoCoreKotlinCoroutineContext>)userContext suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__157__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__158__awaitFreeSpaceDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__158__awaitFreeSpace(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__159__writeAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(AquisitoCoreKtor_ioChunkBuffer *)src suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__159__writeAvailable(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__15__reactToRatingDispatchReceiver:(id<AquisitoCoreRatingPlaceRepository>)dispatchReceiver ratingId:(int32_t)ratingId reactionType:(NSString *)reactionType suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__15__reactToRating(dispatchReceiver:ratingId:reactionType:suspendHandler:)")));
+ (void)Skie_Suspend__160__writeAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(AquisitoCoreKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__160__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__161__writeAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__161__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__162__writeAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__162__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__163__writeByteDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver b:(int8_t)b suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__163__writeByte(dispatchReceiver:b:suspendHandler:)")));
+ (void)Skie_Suspend__164__writeDoubleDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver d:(double)d suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__164__writeDouble(dispatchReceiver:d:suspendHandler:)")));
+ (void)Skie_Suspend__165__writeFloatDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver f:(float)f suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__165__writeFloat(dispatchReceiver:f:suspendHandler:)")));
+ (void)Skie_Suspend__166__writeFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver memory:(AquisitoCoreKtor_ioMemory *)memory startIndex:(int32_t)startIndex endIndex:(int32_t)endIndex suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__166__writeFully(dispatchReceiver:memory:startIndex:endIndex:suspendHandler:)")));
+ (void)Skie_Suspend__167__writeFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(AquisitoCoreKtor_ioBuffer *)src suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__167__writeFully(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__168__writeFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(AquisitoCoreKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__168__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__169__writeFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__169__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__16__removeToReactionDispatchReceiver:(id<AquisitoCoreRatingPlaceRepository>)dispatchReceiver ratingId:(int32_t)ratingId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__16__removeToReaction(dispatchReceiver:ratingId:suspendHandler:)")));
+ (void)Skie_Suspend__170__writeFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__170__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__171__writeIntDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver i:(int32_t)i suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__171__writeInt(dispatchReceiver:i:suspendHandler:)")));
+ (void)Skie_Suspend__172__writeLongDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver l:(int64_t)l suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__172__writeLong(dispatchReceiver:l:suspendHandler:)")));
+ (void)Skie_Suspend__173__writePacketDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver packet:(AquisitoCoreKtor_ioByteReadPacket *)packet suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__173__writePacket(dispatchReceiver:packet:suspendHandler:)")));
+ (void)Skie_Suspend__174__writeShortDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver s:(int16_t)s suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__174__writeShort(dispatchReceiver:s:suspendHandler:)")));
+ (void)Skie_Suspend__175__writeSuspendSessionDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver visitor:(id<AquisitoCoreKotlinSuspendFunction1>)visitor suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__175__writeSuspendSession(dispatchReceiver:visitor:suspendHandler:)")));
+ (void)Skie_Suspend__176__writeToDispatchReceiver:(AquisitoCoreKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<AquisitoCoreKtor_ioByteWriteChannel>)channel suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__176__writeTo(dispatchReceiver:channel:suspendHandler:)")));
+ (void)Skie_Suspend__17__upsertRatingDispatchReceiver:(id<AquisitoCoreRatingPlaceRepository>)dispatchReceiver slug:(NSString *)slug overallRating:(int32_t)overallRating foodRating:(AquisitoCoreInt * _Nullable)foodRating serviceRating:(AquisitoCoreInt * _Nullable)serviceRating ambienceRating:(AquisitoCoreInt * _Nullable)ambienceRating priceRating:(AquisitoCoreInt * _Nullable)priceRating comment:(NSString * _Nullable)comment images:(NSArray<AquisitoCoreKmpFile *> *)images suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__17__upsertRating(dispatchReceiver:slug:overallRating:foodRating:serviceRating:ambienceRating:priceRating:comment:images:suspendHandler:)")));
+ (void)Skie_Suspend__18__invokeDispatchReceiver:(AquisitoCoreUpdateUserProfileUseCase *)dispatchReceiver firstName:(NSString *)firstName lastName:(NSString *)lastName email:(NSString *)email birthDate:(NSString *)birthDate phone:(NSString *)phone suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__18__invoke(dispatchReceiver:firstName:lastName:email:birthDate:phone:suspendHandler:)")));
+ (void)Skie_Suspend__19__getUserDataDispatchReceiver:(id<AquisitoCoreUserRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__19__getUserData(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__1__collectDispatchReceiver:(id<AquisitoCoreKotlinx_coroutines_coreFlow>)dispatchReceiver collector:(id<AquisitoCoreKotlinx_coroutines_coreFlowCollector>)collector suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__1__collect(dispatchReceiver:collector:suspendHandler:)")));
+ (void)Skie_Suspend__20__getUserDataOnContextDispatchReceiver:(id<AquisitoCoreUserRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__20__getUserDataOnContext(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__21__updateUserProfileDispatchReceiver:(id<AquisitoCoreUserRepository>)dispatchReceiver firstName:(NSString *)firstName lastName:(NSString *)lastName email:(NSString *)email birthDate:(NSString *)birthDate phone:(NSString *)phone suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__21__updateUserProfile(dispatchReceiver:firstName:lastName:email:birthDate:phone:suspendHandler:)")));
+ (void)Skie_Suspend__22__invokeDispatchReceiver:(AquisitoCoreUpdatePasswordUseCase *)dispatchReceiver currentPassword:(NSString *)currentPassword password:(NSString *)password passwordConfirmation:(NSString *)passwordConfirmation suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__22__invoke(dispatchReceiver:currentPassword:password:passwordConfirmation:suspendHandler:)")));
+ (void)Skie_Suspend__23__invokeDispatchReceiver:(AquisitoCoreSocialLoginUseCase *)dispatchReceiver socialDriver:(NSString *)socialDriver socialToken:(NSString *)socialToken suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__23__invoke(dispatchReceiver:socialDriver:socialToken:suspendHandler:)")));
+ (void)Skie_Suspend__24__invokeDispatchReceiver:(AquisitoCoreSignUpUseCase *)dispatchReceiver firstName:(NSString *)firstName lastName:(NSString *)lastName name:(NSString *)name email:(NSString *)email username:(NSString *)username phone:(NSString * _Nullable)phone password:(NSString * _Nullable)password avatar:(NSString * _Nullable)avatar socialDriver:(NSString * _Nullable)socialDriver socialId:(NSString * _Nullable)socialId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__24__invoke(dispatchReceiver:firstName:lastName:name:email:username:phone:password:avatar:socialDriver:socialId:suspendHandler:)")));
+ (void)Skie_Suspend__25__invokeDispatchReceiver:(AquisitoCoreSetLocationOnContextUseCase *)dispatchReceiver district:(AquisitoCoreDistrict *)district suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__25__invoke(dispatchReceiver:district:suspendHandler:)")));
+ (void)Skie_Suspend__26__clearSelectedDistrictDispatchReceiver:(id<AquisitoCoreLocationRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__26__clearSelectedDistrict(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__27__clearSelectionAndContextDispatchReceiver:(id<AquisitoCoreLocationRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__27__clearSelectionAndContext(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__28__getStoredLocationDispatchReceiver:(id<AquisitoCoreLocationRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__28__getStoredLocation(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__29__setSelectedDistrictDispatchReceiver:(id<AquisitoCoreLocationRepository>)dispatchReceiver district:(AquisitoCoreDistrict *)district suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__29__setSelectedDistrict(dispatchReceiver:district:suspendHandler:)")));
+ (void)Skie_Suspend__2__emitDispatchReceiver:(id<AquisitoCoreKotlinx_coroutines_coreFlowCollector>)dispatchReceiver value:(id _Nullable)value suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__2__emit(dispatchReceiver:value:suspendHandler:)")));
+ (void)Skie_Suspend__30__clearSessionDispatchReceiver:(id<AquisitoCoreSessionManager>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__30__clearSession(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__31__getAccessTokenDispatchReceiver:(id<AquisitoCoreSessionManager>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__31__getAccessToken(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__32__getCurrentUserDispatchReceiver:(id<AquisitoCoreSessionManager>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__32__getCurrentUser(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__33__isLoggedInDispatchReceiver:(id<AquisitoCoreSessionManager>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__33__isLoggedIn(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__34__notifyLoggedInDispatchReceiver:(id<AquisitoCoreSessionManager>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__34__notifyLoggedIn(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__35__saveUserDispatchReceiver:(id<AquisitoCoreSessionManager>)dispatchReceiver user:(AquisitoCoreUser *)user suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__35__saveUser(dispatchReceiver:user:suspendHandler:)")));
+ (void)Skie_Suspend__36__invokeDispatchReceiver:(AquisitoCoreResetPasswordUseCase *)dispatchReceiver email:(NSString *)email code:(NSString *)code password:(NSString *)password passwordConfirmation:(NSString *)passwordConfirmation suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__36__invoke(dispatchReceiver:email:code:password:passwordConfirmation:suspendHandler:)")));
+ (void)Skie_Suspend__37__invokeDispatchReceiver:(AquisitoCoreRemoveReactionUseCase *)dispatchReceiver ratingId:(int32_t)ratingId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__37__invoke(dispatchReceiver:ratingId:suspendHandler:)")));
+ (void)Skie_Suspend__38__invokeDispatchReceiver:(AquisitoCoreRemovePlaceFromCollectionUseCase *)dispatchReceiver collectionSlug:(NSString *)collectionSlug placeSlug:(NSString *)placeSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__38__invoke(dispatchReceiver:collectionSlug:placeSlug:suspendHandler:)")));
+ (void)Skie_Suspend__39__addPlaceToCollectionDispatchReceiver:(id<AquisitoCoreCollectionRepository>)dispatchReceiver collectionSlug:(NSString *)collectionSlug placeId:(int32_t)placeId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__39__addPlaceToCollection(dispatchReceiver:collectionSlug:placeId:suspendHandler:)")));
+ (void)Skie_Suspend__3__invokeDispatchReceiver:(AquisitoCoreVerifyCodeUseCase *)dispatchReceiver email:(NSString *)email code:(NSString *)code suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__3__invoke(dispatchReceiver:email:code:suspendHandler:)")));
+ (void)Skie_Suspend__40__createCollectionDispatchReceiver:(id<AquisitoCoreCollectionRepository>)dispatchReceiver name:(NSString *)name description:(NSString * _Nullable)description type:(NSString *)type isPublic:(BOOL)isPublic trackChanges:(BOOL)trackChanges suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__40__createCollection(dispatchReceiver:name:description:type:isPublic:trackChanges:suspendHandler:)")));
+ (void)Skie_Suspend__41__removeCollectionDispatchReceiver:(id<AquisitoCoreCollectionRepository>)dispatchReceiver collectionSlug:(NSString *)collectionSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__41__removeCollection(dispatchReceiver:collectionSlug:suspendHandler:)")));
+ (void)Skie_Suspend__42__removePlaceFromCollectionDispatchReceiver:(id<AquisitoCoreCollectionRepository>)dispatchReceiver collectionSlug:(NSString *)collectionSlug placeSlug:(NSString *)placeSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__42__removePlaceFromCollection(dispatchReceiver:collectionSlug:placeSlug:suspendHandler:)")));
+ (void)Skie_Suspend__43__invokeDispatchReceiver:(AquisitoCoreRemoveCollectionUseCase *)dispatchReceiver collectionSlug:(NSString *)collectionSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__43__invoke(dispatchReceiver:collectionSlug:suspendHandler:)")));
+ (void)Skie_Suspend__44__invokeDispatchReceiver:(AquisitoCoreRedeemPromotionUseCase *)dispatchReceiver promotionUuid:(NSString *)promotionUuid suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__44__invoke(dispatchReceiver:promotionUuid:suspendHandler:)")));
+ (void)Skie_Suspend__45__getPlacePromotionsDispatchReceiver:(id<AquisitoCorePromotionRepository>)dispatchReceiver placeSlug:(NSString *)placeSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__45__getPlacePromotions(dispatchReceiver:placeSlug:suspendHandler:)")));
+ (void)Skie_Suspend__46__getPromotionDetailDispatchReceiver:(id<AquisitoCorePromotionRepository>)dispatchReceiver placeSlug:(NSString *)placeSlug promotionUuid:(NSString *)promotionUuid suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__46__getPromotionDetail(dispatchReceiver:placeSlug:promotionUuid:suspendHandler:)")));
+ (void)Skie_Suspend__47__redeemPromotionDispatchReceiver:(id<AquisitoCorePromotionRepository>)dispatchReceiver promotionUuid:(NSString *)promotionUuid suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__redeemPromotion(dispatchReceiver:promotionUuid:suspendHandler:)")));
+ (void)Skie_Suspend__48__invokeDispatchReceiver:(AquisitoCoreReactRatingUseCase *)dispatchReceiver ratingId:(int32_t)ratingId reactionType:(AquisitoCoreReactionType *)reactionType suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__48__invoke(dispatchReceiver:ratingId:reactionType:suspendHandler:)")));
+ (void)Skie_Suspend__49__invokeDispatchReceiver:(AquisitoCoreMarkOnboardingCompletedUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__49__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__4__deleteAccountDispatchReceiver:(id<AquisitoCoreAuthRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__4__deleteAccount(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__50__hasCompletedOnboardingDispatchReceiver:(id<AquisitoCoreOnboardingRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__hasCompletedOnboarding(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__51__markOnboardingCompletedDispatchReceiver:(id<AquisitoCoreOnboardingRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__markOnboardingCompleted(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__52__resetOnboardingDispatchReceiver:(id<AquisitoCoreOnboardingRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__resetOnboarding(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__53__invokeDispatchReceiver:(AquisitoCoreLogoutUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__54__invokeDispatchReceiver:(AquisitoCoreLoginUseCase *)dispatchReceiver email:(NSString *)email password:(NSString *)password suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__invoke(dispatchReceiver:email:password:suspendHandler:)")));
+ (void)Skie_Suspend__55__clearAllDispatchReceiver:(AquisitoCoreLocationContext *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__clearAll(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__56__clearDistrictDispatchReceiver:(AquisitoCoreLocationContext *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__clearDistrict(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__57__setDistrictDispatchReceiver:(AquisitoCoreLocationContext *)dispatchReceiver district:(AquisitoCoreDistrict *)district suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__57__setDistrict(dispatchReceiver:district:suspendHandler:)")));
+ (void)Skie_Suspend__58__invokeDispatchReceiver:(AquisitoCoreGetListRatingsUseCase *)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__58__invoke(dispatchReceiver:slug:suspendHandler:)")));
+ (void)Skie_Suspend__59__invokeDispatchReceiver:(AquisitoCoreListPlacePromotionsUseCase *)dispatchReceiver placeSlug:(NSString *)placeSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__59__invoke(dispatchReceiver:placeSlug:suspendHandler:)")));
+ (void)Skie_Suspend__5__forgotPasswordDispatchReceiver:(id<AquisitoCoreAuthRepository>)dispatchReceiver email:(NSString *)email suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__5__forgotPassword(dispatchReceiver:email:suspendHandler:)")));
+ (void)Skie_Suspend__60__invokeDispatchReceiver:(AquisitoCoreGetUserDataUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__60__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__61__invokeDispatchReceiver:(AquisitoCoreGetPromotionDetailUseCase *)dispatchReceiver placeSlug:(NSString *)placeSlug promotionUuid:(NSString *)promotionUuid suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__61__invoke(dispatchReceiver:placeSlug:promotionUuid:suspendHandler:)")));
+ (void)Skie_Suspend__62__invokeDispatchReceiver:(AquisitoCoreGetPlacesUseCase *)dispatchReceiver query:(NSDictionary<NSString *, NSString *> *)query suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__62__invoke(dispatchReceiver:query:suspendHandler:)")));
+ (void)Skie_Suspend__63__getPlaceDetailDispatchReceiver:(id<AquisitoCorePlaceRepository>)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__63__getPlaceDetail(dispatchReceiver:slug:suspendHandler:)")));
+ (void)Skie_Suspend__64__getPlacesDispatchReceiver:(id<AquisitoCorePlaceRepository>)dispatchReceiver query:(NSDictionary<NSString *, NSString *> *)query suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__64__getPlaces(dispatchReceiver:query:suspendHandler:)")));
+ (void)Skie_Suspend__65__invokeDispatchReceiver:(AquisitoCoreGetPlaceDetailUseCase *)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__65__invoke(dispatchReceiver:slug:suspendHandler:)")));
+ (void)Skie_Suspend__66__invokeDispatchReceiver:(AquisitoCoreGetOnboardingStatusUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__66__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__67__invokeDispatchReceiver:(AquisitoCoreGetUserDataOnContextUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__67__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__68__invokeDispatchReceiver:(AquisitoCoreGetCartDetailUseCase *)dispatchReceiver slug:(NSString *)slug id:(int32_t)id suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__68__invoke(dispatchReceiver:slug:id:suspendHandler:)")));
+ (void)Skie_Suspend__69__getCartDetailDispatchReceiver:(id<AquisitoCoreCartRepository>)dispatchReceiver slug:(NSString *)slug id:(int32_t)id suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__69__getCartDetail(dispatchReceiver:slug:id:suspendHandler:)")));
+ (void)Skie_Suspend__6__loginDispatchReceiver:(id<AquisitoCoreAuthRepository>)dispatchReceiver email:(NSString *)email password:(NSString *)password suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__6__login(dispatchReceiver:email:password:suspendHandler:)")));
+ (void)Skie_Suspend__70__invokeDispatchReceiver:(AquisitoCoreGetAvailableAreaByLocationUseCase *)dispatchReceiver latitude:(double)latitude longitude:(double)longitude suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__70__invoke(dispatchReceiver:latitude:longitude:suspendHandler:)")));
+ (void)Skie_Suspend__71__getAvailableAreaByLocationDispatchReceiver:(id<AquisitoCoreAreaRepository>)dispatchReceiver latitude:(double)latitude longitude:(double)longitude suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__71__getAvailableAreaByLocation(dispatchReceiver:latitude:longitude:suspendHandler:)")));
+ (void)Skie_Suspend__72__getAvailableAreasDispatchReceiver:(id<AquisitoCoreAreaRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__72__getAvailableAreas(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__73__invokeDispatchReceiver:(AquisitoCoreForgotPasswordUseCase *)dispatchReceiver email:(NSString *)email suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__73__invoke(dispatchReceiver:email:suspendHandler:)")));
+ (void)Skie_Suspend__74__invokeDispatchReceiver:(AquisitoCoreEnsureSetLocationUserUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__74__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__75__getApproxLocationDispatchReceiver:(id<AquisitoCoreLocationClient>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__75__getApproxLocation(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__76__invokeDispatchReceiver:(AquisitoCoreDeleteAccountUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__76__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__77__invokeDispatchReceiver:(AquisitoCoreCreateCollectionUseCase *)dispatchReceiver name:(NSString *)name description:(NSString * _Nullable)description type:(NSString *)type isPublic:(BOOL)isPublic trackChanges:(BOOL)trackChanges suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__77__invoke(dispatchReceiver:name:description:type:isPublic:trackChanges:suspendHandler:)")));
+ (void)Skie_Suspend__78__invokeDispatchReceiver:(AquisitoCoreCheckUserLocationUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__78__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__79__invokeDispatchReceiver:(AquisitoCoreGetAvailableAreasUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__79__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__7__loginSocialDispatchReceiver:(id<AquisitoCoreAuthRepository>)dispatchReceiver socialDriver:(NSString *)socialDriver socialToken:(NSString *)socialToken suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__7__loginSocial(dispatchReceiver:socialDriver:socialToken:suspendHandler:)")));
+ (void)Skie_Suspend__80__invokeDispatchReceiver:(AquisitoCoreAddPlaceToCollectionUseCase *)dispatchReceiver collectionSlug:(NSString *)collectionSlug placeId:(int32_t)placeId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__80__invoke(dispatchReceiver:collectionSlug:placeId:suspendHandler:)")));
+ (void)Skie_Suspend__81__executeDispatchReceiver:(id<AquisitoCoreKtor_client_coreHttpClientEngine>)dispatchReceiver data:(AquisitoCoreKtor_client_coreHttpRequestData *)data suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__81__execute(dispatchReceiver:data:suspendHandler:)")));
+ (void)Skie_Suspend__82__joinDispatchReceiver:(id<AquisitoCoreKotlinx_coroutines_coreJob>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__82__join(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__83__executeDispatchReceiver:(AquisitoCoreKtor_utilsPipeline<id, id> *)dispatchReceiver context:(id)context subject:(id)subject suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__83__execute(dispatchReceiver:context:subject:suspendHandler:)")));
+ (void)Skie_Suspend__84__invokeDispatchReceiver:(id<AquisitoCoreKotlinSuspendFunction2>)dispatchReceiver p1:(id _Nullable)p1 p2:(id _Nullable)p2 suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__84__invoke(dispatchReceiver:p1:p2:suspendHandler:)")));
+ (void)Skie_Suspend__85__bodyDispatchReceiver:(AquisitoCoreKtor_client_coreHttpClientCall *)dispatchReceiver info:(AquisitoCoreKtor_utilsTypeInfo *)info suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__85__body(dispatchReceiver:info:suspendHandler:)")));
+ (void)Skie_Suspend__86__bodyNullableDispatchReceiver:(AquisitoCoreKtor_client_coreHttpClientCall *)dispatchReceiver info:(AquisitoCoreKtor_utilsTypeInfo *)info suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__86__bodyNullable(dispatchReceiver:info:suspendHandler:)")));

/**
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
+ (void)Skie_Suspend__87__getResponseContentDispatchReceiver:(AquisitoCoreKtor_client_coreHttpClientCall *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__87__getResponseContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__88__awaitContentDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__88__awaitContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__89__discardDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver max:(int64_t)max suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__89__discard(dispatchReceiver:max:suspendHandler:)")));
+ (void)Skie_Suspend__8__logoutDispatchReceiver:(id<AquisitoCoreAuthRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__8__logout(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__90__peekToDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver destination:(AquisitoCoreKtor_ioMemory *)destination destinationOffset:(int64_t)destinationOffset offset:(int64_t)offset min:(int64_t)min max:(int64_t)max suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__90__peekTo(dispatchReceiver:destination:destinationOffset:offset:min:max:suspendHandler:)")));
+ (void)Skie_Suspend__91__readAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(AquisitoCoreKtor_ioChunkBuffer *)dst suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__91__readAvailable(dispatchReceiver:dst:suspendHandler:)")));
+ (void)Skie_Suspend__92__readAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(AquisitoCoreKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__92__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__93__readAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__93__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__94__readAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int64_t)offset length:(int64_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__94__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__95__readBooleanDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__95__readBoolean(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__96__readByteDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__96__readByte(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__97__readDoubleDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__97__readDouble(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__98__readFloatDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__98__readFloat(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__99__readFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(AquisitoCoreKtor_ioChunkBuffer *)dst n:(int32_t)n suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__99__readFully(dispatchReceiver:dst:n:suspendHandler:)")));
+ (void)Skie_Suspend__9__resetPasswordDispatchReceiver:(id<AquisitoCoreAuthRepository>)dispatchReceiver email:(NSString *)email code:(NSString *)code password:(NSString *)password passwordConfirmation:(NSString *)passwordConfirmation suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__9__resetPassword(dispatchReceiver:email:code:password:passwordConfirmation:suspendHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("__SkieTypeExportsKt")))
@interface AquisitoCore__SkieTypeExportsKt : AquisitoCoreBase
+ (void)skieTypeExports_0P0:(AquisitoCoreKtor_httpOutgoingContentByteArrayContent *)p0 p1:(AquisitoCoreKtor_httpOutgoingContentNoContent *)p1 p2:(AquisitoCoreKtor_httpOutgoingContentProtocolUpgrade *)p2 p3:(AquisitoCoreKtor_httpOutgoingContentReadChannelContent *)p3 p4:(AquisitoCoreKtor_httpOutgoingContentWriteChannelContent *)p4 p5:(id<AquisitoCoreKotlinx_coroutines_coreSelectClause1>)p5 p6:(id<AquisitoCoreKotlinx_coroutines_coreSelectClause2>)p6 p7:(AquisitoCoreKotlinx_serialization_corePolymorphicKind *)p7 p8:(AquisitoCoreKotlinx_serialization_corePolymorphicKindOPEN *)p8 p9:(AquisitoCoreKotlinx_serialization_corePolymorphicKindSEALED *)p9 p10:(AquisitoCoreKotlinx_serialization_corePrimitiveKind *)p10 p11:(AquisitoCoreKotlinx_serialization_corePrimitiveKindBOOLEAN *)p11 p12:(AquisitoCoreKotlinx_serialization_corePrimitiveKindBYTE *)p12 p13:(AquisitoCoreKotlinx_serialization_corePrimitiveKindCHAR *)p13 p14:(AquisitoCoreKotlinx_serialization_corePrimitiveKindDOUBLE *)p14 p15:(AquisitoCoreKotlinx_serialization_corePrimitiveKindFLOAT *)p15 p16:(AquisitoCoreKotlinx_serialization_corePrimitiveKindINT *)p16 p17:(AquisitoCoreKotlinx_serialization_corePrimitiveKindLONG *)p17 p18:(AquisitoCoreKotlinx_serialization_corePrimitiveKindSHORT *)p18 p19:(AquisitoCoreKotlinx_serialization_corePrimitiveKindSTRING *)p19 p20:(AquisitoCoreKotlinx_serialization_coreSerialKindCONTEXTUAL *)p20 p21:(AquisitoCoreKotlinx_serialization_coreSerialKindENUM *)p21 p22:(AquisitoCoreKotlinx_serialization_coreStructureKind *)p22 p23:(AquisitoCoreKotlinx_serialization_coreStructureKindCLASS *)p23 p24:(AquisitoCoreKotlinx_serialization_coreStructureKindLIST *)p24 p25:(AquisitoCoreKotlinx_serialization_coreStructureKindMAP *)p25 p26:(AquisitoCoreKotlinx_serialization_coreStructureKindOBJECT *)p26 p27:(AquisitoCoreKotlinx_serialization_jsonJsonNull *)p27 p28:(AquisitoCoreKotlinx_serialization_jsonJsonPrimitive *)p28 __attribute__((swift_name("skieTypeExports_0(p0:p1:p2:p3:p4:p5:p6:p7:p8:p9:p10:p11:p12:p13:p14:p15:p16:p17:p18:p19:p20:p21:p22:p23:p24:p25:p26:p27:p28:)")));
@end
...
@interface AquisitoCoreRoom_runtimeMigration : AquisitoCoreBase
...
- (void)migrateConnection:(id<AquisitoCoreSqliteSQLiteConnection>)connection __attribute__((swift_name("migrate(connection:)")));
@end
...
@protocol AquisitoCoreRoom_runtimeAutoMigrationSpec
@required
- (void)onPostMigrateConnection:(id<AquisitoCoreSqliteSQLiteConnection>)connection __attribute__((swift_name("onPostMigrate(connection:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Room_runtimeInvalidationTracker")))
@interface AquisitoCoreRoom_runtimeInvalidationTracker : AquisitoCoreBase

/**
 * @note annotations
 *   androidx.annotation.RestrictTo(value=[Scope.LIBRARY_GROUP_PREFIX])
*/
- (instancetype)initWithDatabase:(AquisitoCoreRoom_runtimeRoomDatabase *)database shadowTablesMap:(NSDictionary<NSString *, NSString *> *)shadowTablesMap viewTables:(NSDictionary<NSString *, NSSet<NSString *> *> *)viewTables tableNames:(AquisitoCoreKotlinArray<NSString *> *)tableNames __attribute__((swift_name("init(database:shadowTablesMap:viewTables:tableNames:)"))) __attribute__((objc_designated_initializer));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (id<AquisitoCoreKotlinx_coroutines_coreFlow>)createFlowTables:(AquisitoCoreKotlinArray<NSString *> *)tables emitInitialState:(BOOL)emitInitialState __attribute__((swift_name("createFlow(tables:emitInitialState:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)refreshTables:(AquisitoCoreKotlinArray<NSString *> *)tables completionHandler:(void (^)(AquisitoCoreBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("refresh(tables:completionHandler:)")));
- (void)refreshAsync __attribute__((swift_name("refreshAsync()")));
@end

__attribute__((swift_name("Room_runtimeRoomOpenDelegateMarker")))
@protocol AquisitoCoreRoom_runtimeRoomOpenDelegateMarker
@required
@end
...
@protocol AquisitoCoreKotlinAutoCloseable
@required
- (void)close __attribute__((swift_name("close()")));
@end

__attribute__((swift_name("SqliteSQLiteConnection")))
@protocol AquisitoCoreSqliteSQLiteConnection <AquisitoCoreKotlinAutoCloseable>
@required
- (id<AquisitoCoreSqliteSQLiteStatement>)prepareSql:(NSString *)sql __attribute__((swift_name("prepare(sql:)")));
@end
...
@interface AquisitoCoreRoom_runtimeRoomOpenDelegate : AquisitoCoreBase <AquisitoCoreRoom_runtimeRoomOpenDelegateMarker>
...
- (void)createAllTablesConnection:(id<AquisitoCoreSqliteSQLiteConnection>)connection __attribute__((swift_name("createAllTables(connection:)")));
- (void)dropAllTablesConnection:(id<AquisitoCoreSqliteSQLiteConnection>)connection __attribute__((swift_name("dropAllTables(connection:)")));
- (void)onCreateConnection:(id<AquisitoCoreSqliteSQLiteConnection>)connection __attribute__((swift_name("onCreate(connection:)")));
- (void)onOpenConnection:(id<AquisitoCoreSqliteSQLiteConnection>)connection __attribute__((swift_name("onOpen(connection:)")));
- (void)onPostMigrateConnection:(id<AquisitoCoreSqliteSQLiteConnection>)connection __attribute__((swift_name("onPostMigrate(connection:)")));
- (void)onPreMigrateConnection:(id<AquisitoCoreSqliteSQLiteConnection>)connection __attribute__((swift_name("onPreMigrate(connection:)")));
- (AquisitoCoreRoom_runtimeRoomOpenDelegateValidationResult *)onValidateSchemaConnection:(id<AquisitoCoreSqliteSQLiteConnection>)connection __attribute__((swift_name("onValidateSchema(connection:)")));
@end
...
@interface AquisitoCoreKotlinx_serialization_jsonJsonElement : AquisitoCoreBase
@property (class, readonly, getter=companion) AquisitoCoreKotlinx_serialization_jsonJsonElementCompanion *companion __attribute__((swift_name("companion")));
@end
...
- (BOOL)cancelCause:(AquisitoCoreKotlinThrowable * _Nullable)cause __attribute__((swift_name("cancel(cause:)")));
...
@interface AquisitoCoreKtor_httpOutgoingContentProtocolUpgrade : AquisitoCoreKtor_httpOutgoingContent
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)upgradeInput:(id<AquisitoCoreKtor_ioByteReadChannel>)input output:(id<AquisitoCoreKtor_ioByteWriteChannel>)output engineContext:(id<AquisitoCoreKotlinCoroutineContext>)engineContext userContext:(id<AquisitoCoreKotlinCoroutineContext>)userContext completionHandler:(void (^)(id<AquisitoCoreKotlinx_coroutines_coreJob> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("upgrade(input:output:engineContext:userContext:completionHandler:)")));
@end

__attribute__((swift_name("Ktor_ioByteWriteChannel")))
@protocol AquisitoCoreKtor_ioByteWriteChannel
@required
...
- (BOOL)closeCause:(AquisitoCoreKotlinThrowable * _Nullable)cause __attribute__((swift_name("close(cause:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeAvailableSrc:(AquisitoCoreKtor_ioChunkBuffer *)src completionHandler:(void (^)(AquisitoCoreInt * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("writeAvailable(src:completionHandler:)")));
- (int32_t)writeAvailableMin:(int32_t)min block:(void (^)(AquisitoCoreKtor_ioBuffer *))block __attribute__((swift_name("writeAvailable(min:block:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeAvailableSrc:(AquisitoCoreKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length completionHandler:(void (^)(AquisitoCoreInt * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("writeAvailable(src:offset:length:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeAvailableSrc:(void *)src offset:(int32_t)offset length:(int32_t)length completionHandler_:(void (^)(AquisitoCoreInt * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("writeAvailable(src:offset:length:completionHandler_:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeAvailableSrc:(void *)src offset:(int64_t)offset length:(int64_t)length completionHandler__:(void (^)(AquisitoCoreInt * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("writeAvailable(src:offset:length:completionHandler__:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeFullySrc:(AquisitoCoreKtor_ioBuffer *)src completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writeFully(src:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeFullyMemory:(AquisitoCoreKtor_ioMemory *)memory startIndex:(int32_t)startIndex endIndex:(int32_t)endIndex completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writeFully(memory:startIndex:endIndex:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeFullySrc:(AquisitoCoreKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writeFully(src:offset:length:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writePacketPacket:(AquisitoCoreKtor_ioByteReadPacket *)packet completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writePacket(packet:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeSuspendSessionVisitor:(id<AquisitoCoreKotlinSuspendFunction1>)visitor completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writeSuspendSession(visitor:completionHandler:)"))) __attribute__((deprecated("Use write { } instead.")));
...
@property AquisitoCoreKtor_ioChunkBuffer * _Nullable next __attribute__((swift_name("next")));
...
@interface AquisitoCoreKtor_httpOutgoingContentWriteChannelContent : AquisitoCoreKtor_httpOutgoingContent
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeToChannel:(id<AquisitoCoreKtor_ioByteWriteChannel>)channel completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writeTo(channel:completionHandler:)")));
@end
...
- (void)cancelCause_:(AquisitoCoreKotlinCancellationException * _Nullable)cause __attribute__((swift_name("cancel(cause_:)")));
...
@interface AquisitoCoreKtor_httpOutgoingContentByteArrayContent : AquisitoCoreKtor_httpOutgoingContent
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AquisitoCoreKotlinByteArray *)bytes __attribute__((swift_name("bytes()")));
@end

__attribute__((swift_name("Ktor_httpOutgoingContent.NoContent")))
@interface AquisitoCoreKtor_httpOutgoingContentNoContent : AquisitoCoreKtor_httpOutgoingContent
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end

__attribute__((swift_name("Ktor_httpOutgoingContent.ReadChannelContent")))
@interface AquisitoCoreKtor_httpOutgoingContentReadChannelContent : AquisitoCoreKtor_httpOutgoingContent
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (id<AquisitoCoreKtor_ioByteReadChannel>)readFrom __attribute__((swift_name("readFrom()")));
- (id<AquisitoCoreKtor_ioByteReadChannel>)readFromRange:(AquisitoCoreKotlinLongRange *)range __attribute__((swift_name("readFrom(range:)")));
@end
...
@protocol AquisitoCoreKotlinx_coroutines_coreSelectClause1 <AquisitoCoreKotlinx_coroutines_coreSelectClause>
@required
@end

__attribute__((swift_name("Kotlinx_coroutines_coreSelectClause2")))
@protocol AquisitoCoreKotlinx_coroutines_coreSelectClause2 <AquisitoCoreKotlinx_coroutines_coreSelectClause>
@required
@end
...
@interface AquisitoCoreKotlinx_serialization_corePolymorphicKind : AquisitoCoreKotlinx_serialization_coreSerialKind
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kotlinx_serialization_corePolymorphicKind.OPEN")))
@interface AquisitoCoreKotlinx_serialization_corePolymorphicKindOPEN : AquisitoCoreKotlinx_serialization_corePolymorphicKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePolymorphicKindOPEN *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_corePolymorphicKindSEALED : AquisitoCoreKotlinx_serialization_corePolymorphicKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePolymorphicKindSEALED *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_corePrimitiveKind : AquisitoCoreKotlinx_serialization_coreSerialKind
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kotlinx_serialization_corePrimitiveKind.BOOLEAN")))
@interface AquisitoCoreKotlinx_serialization_corePrimitiveKindBOOLEAN : AquisitoCoreKotlinx_serialization_corePrimitiveKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePrimitiveKindBOOLEAN *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_corePrimitiveKindBYTE : AquisitoCoreKotlinx_serialization_corePrimitiveKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePrimitiveKindBYTE *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_corePrimitiveKindCHAR : AquisitoCoreKotlinx_serialization_corePrimitiveKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePrimitiveKindCHAR *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_corePrimitiveKindDOUBLE : AquisitoCoreKotlinx_serialization_corePrimitiveKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePrimitiveKindDOUBLE *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_corePrimitiveKindFLOAT : AquisitoCoreKotlinx_serialization_corePrimitiveKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePrimitiveKindFLOAT *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_corePrimitiveKindINT : AquisitoCoreKotlinx_serialization_corePrimitiveKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePrimitiveKindINT *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_corePrimitiveKindLONG : AquisitoCoreKotlinx_serialization_corePrimitiveKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePrimitiveKindLONG *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_corePrimitiveKindSHORT : AquisitoCoreKotlinx_serialization_corePrimitiveKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePrimitiveKindSHORT *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_corePrimitiveKindSTRING : AquisitoCoreKotlinx_serialization_corePrimitiveKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_corePrimitiveKindSTRING *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_coreSerialKindCONTEXTUAL : AquisitoCoreKotlinx_serialization_coreSerialKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_coreSerialKindCONTEXTUAL *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_coreSerialKindENUM : AquisitoCoreKotlinx_serialization_coreSerialKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_coreSerialKindENUM *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_coreStructureKind : AquisitoCoreKotlinx_serialization_coreSerialKind
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kotlinx_serialization_coreStructureKind.CLASS")))
@interface AquisitoCoreKotlinx_serialization_coreStructureKindCLASS : AquisitoCoreKotlinx_serialization_coreStructureKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_coreStructureKindCLASS *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_coreStructureKindLIST : AquisitoCoreKotlinx_serialization_coreStructureKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_coreStructureKindLIST *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_coreStructureKindMAP : AquisitoCoreKotlinx_serialization_coreStructureKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_coreStructureKindMAP *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_coreStructureKindOBJECT : AquisitoCoreKotlinx_serialization_coreStructureKind
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_coreStructureKindOBJECT *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AquisitoCoreKotlinx_serialization_jsonJsonPrimitive : AquisitoCoreKotlinx_serialization_jsonJsonElement
@property (class, readonly, getter=companion) AquisitoCoreKotlinx_serialization_jsonJsonPrimitiveCompanion *companion __attribute__((swift_name("companion")));
...
@interface AquisitoCoreKotlinx_serialization_jsonJsonNull : AquisitoCoreKotlinx_serialization_jsonJsonPrimitive
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_jsonJsonNull *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *content __attribute__((swift_name("content")));
@property (readonly) BOOL isString __attribute__((swift_name("isString")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
- (AquisitoCoreKotlinx_coroutines_coreCoroutineDispatcher *)plusOther_:(AquisitoCoreKotlinx_coroutines_coreCoroutineDispatcher *)other __attribute__((swift_name("plus(other_:)"))) __attribute__((unavailable("Operator '+' on two CoroutineDispatcher objects is meaningless. CoroutineDispatcher is a coroutine context element and `+` is a set-sum operator for coroutine contexts. The dispatcher to the right of `+` just replaces the dispatcher to the left.")));
- (void)releaseInterceptedContinuationContinuation:(id<AquisitoCoreKotlinContinuation>)continuation __attribute__((swift_name("releaseInterceptedContinuation(continuation:)")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@protocol AquisitoCoreSqliteSQLiteStatement <AquisitoCoreKotlinAutoCloseable>
@required

/**
 * @param index annotations androidx.annotation.IntRange(from=1.toLong())
*/
- (void)bindBlobIndex:(int32_t)index value:(AquisitoCoreKotlinByteArray *)value __attribute__((swift_name("bindBlob(index:value:)")));
...
*/
- (AquisitoCoreKotlinByteArray *)getBlobIndex:(int32_t)index __attribute__((swift_name("getBlob(index:)")));
...
@interface AquisitoCoreRoom_runtimeRoomOpenDelegateValidationResult : AquisitoCoreBase
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AquisitoCoreByte *)next_ __attribute__((swift_name("next()")));
...
@interface AquisitoCoreKotlinx_serialization_jsonJsonElementCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_jsonJsonElementCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AquisitoCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@protocol AquisitoCoreKotlinIterable
@required
- (id<AquisitoCoreKotlinIterator>)iterator __attribute__((swift_name("iterator()")));
@end

__attribute__((swift_name("KotlinLongProgression")))
@interface AquisitoCoreKotlinLongProgression : AquisitoCoreBase <AquisitoCoreKotlinIterable>
@property (class, readonly, getter=companion) AquisitoCoreKotlinLongProgressionCompanion *companion __attribute__((swift_name("companion")));
...
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (BOOL)isEmpty __attribute__((swift_name("isEmpty()")));
- (AquisitoCoreKotlinLongIterator *)iterator __attribute__((swift_name("iterator()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end

__attribute__((swift_name("KotlinClosedRange")))
@protocol AquisitoCoreKotlinClosedRange
@required
...
@protocol AquisitoCoreKotlinOpenEndRange
@required
...
@interface AquisitoCoreKotlinLongRange : AquisitoCoreKotlinLongProgression <AquisitoCoreKotlinClosedRange, AquisitoCoreKotlinOpenEndRange>
@property (class, readonly, getter=companion) AquisitoCoreKotlinLongRangeCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) AquisitoCoreLong *endExclusive __attribute__((swift_name("endExclusive"))) __attribute__((deprecated("Can throw an exception when it's impossible to represent the value with Long type, for example, when the range includes MAX_VALUE. It's recommended to use 'endInclusive' property that doesn't throw.")));
@property (readonly) AquisitoCoreLong *endInclusive __attribute__((swift_name("endInclusive")));
@property (readonly, getter=start_) AquisitoCoreLong *start __attribute__((swift_name("start")));
...
- (BOOL)containsValue:(AquisitoCoreLong *)value __attribute__((swift_name("contains(value:)")));
- (BOOL)containsValue_:(AquisitoCoreLong *)value __attribute__((swift_name("contains(value_:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (BOOL)isEmpty __attribute__((swift_name("isEmpty()")));
- (BOOL)isEmpty_ __attribute__((swift_name("isEmpty()")));
...
@interface AquisitoCoreKotlinx_serialization_jsonJsonPrimitiveCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCoreKotlinx_serialization_jsonJsonPrimitiveCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AquisitoCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@interface AquisitoCoreKotlinLongProgressionCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCoreKotlinLongProgressionCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AquisitoCoreKotlinLongProgression *)fromClosedRangeRangeStart:(int64_t)rangeStart rangeEnd:(int64_t)rangeEnd step:(int64_t)step __attribute__((swift_name("fromClosedRange(rangeStart:rangeEnd:step:)")));
@end

__attribute__((swift_name("KotlinLongIterator")))
@interface AquisitoCoreKotlinLongIterator : AquisitoCoreBase <AquisitoCoreKotlinIterator>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AquisitoCoreLong *)next_ __attribute__((swift_name("next()")));
- (int64_t)nextLong __attribute__((swift_name("nextLong()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KotlinLongRange.Companion")))
@interface AquisitoCoreKotlinLongRangeCompanion : AquisitoCoreBase
@property (class, readonly, getter=shared) AquisitoCoreKotlinLongRangeCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) AquisitoCoreKotlinLongRange *EMPTY __attribute__((swift_name("EMPTY")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@end
