...
- (instancetype)initWithLocationClient:(id<AquisitoCoreLocationClient>)locationClient repository:(id<AquisitoCoreLocationRepository>)repository getAvailableAreaByLocationUseCase:(AquisitoCoreGetAvailableAreaByLocationUseCase *)getAvailableAreaByLocationUseCase matchRadiusMeters:(double)matchRadiusMeters __attribute__((swift_name("init(locationClient:repository:getAvailableAreaByLocationUseCase:matchRadiusMeters:)"))) __attribute__((objc_designated_initializer));
