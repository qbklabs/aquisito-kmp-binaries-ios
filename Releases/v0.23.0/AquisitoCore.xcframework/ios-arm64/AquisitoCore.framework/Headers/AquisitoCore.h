...
@property (readonly) NSArray<AquisitoCoreCartEntryDto *> * _Nullable cartEntries __attribute__((swift_name("cartEntries")));
...
@property (readonly) NSArray<AquisitoCoreMenuEntryDto *> * _Nullable popularDishes __attribute__((swift_name("popularDishes")));
@property (readonly) NSString * _Nullable price_range __attribute__((swift_name("price_range")));
@property (readonly) AquisitoCoreProvinceDto * _Nullable province __attribute__((swift_name("province")));
@property (readonly) NSArray<AquisitoCoreReservationDto *> * _Nullable reservations __attribute__((swift_name("reservations")));
