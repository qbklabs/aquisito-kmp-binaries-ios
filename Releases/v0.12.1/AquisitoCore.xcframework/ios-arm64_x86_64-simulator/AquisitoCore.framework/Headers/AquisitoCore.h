...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MenuCategoryDto")))
@interface AquisitoCoreMenuCategoryDto : AquisitoCoreBase
- (instancetype)initWithCategory:(NSString * _Nullable)category items:(NSArray<AquisitoCoreMenuEntryDto *> * _Nullable)items __attribute__((swift_name("init(category:items:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) AquisitoCoreMenuCategoryDtoCompanion *companion __attribute__((swift_name("companion")));
- (AquisitoCoreMenuCategoryDto *)doCopyCategory:(NSString * _Nullable)category items:(NSArray<AquisitoCoreMenuEntryDto *> * _Nullable)items __attribute__((swift_name("doCopy(category:items:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable category __attribute__((swift_name("category")));
@property (readonly) NSArray<AquisitoCoreMenuEntryDto *> * _Nullable items __attribute__((swift_name("items")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MenuCategoryDto.Companion")))
@interface AquisitoCoreMenuCategoryDtoCompanion : AquisitoCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) AquisitoCoreMenuCategoryDtoCompanion *shared __attribute__((swift_name("shared")));
- (id<AquisitoCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@property (readonly) NSArray<AquisitoCoreMenuCategoryDto *> * _Nullable menuEntries __attribute__((swift_name("menuEntries")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
@property (readonly) BOOL featured __attribute__((swift_name("featured")));
@property (readonly) NSArray<AquisitoCoreMenuEntry *> *featuredDishes __attribute__((swift_name("featuredDishes")));
