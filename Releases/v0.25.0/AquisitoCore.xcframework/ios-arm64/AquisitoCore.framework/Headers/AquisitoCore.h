...
- (instancetype)initWithFood_rating:(int32_t)food_rating service_rating:(int32_t)service_rating ambience_rating:(int32_t)ambience_rating price_rating:(int32_t)price_rating comment:(NSString * _Nullable)comment images:(NSArray<AquisitoCoreKmpFile *> *)images __attribute__((swift_name("init(food_rating:service_rating:ambience_rating:price_rating:comment:images:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreRatingRequest *)doCopyFood_rating:(int32_t)food_rating service_rating:(int32_t)service_rating ambience_rating:(int32_t)ambience_rating price_rating:(int32_t)price_rating comment:(NSString * _Nullable)comment images:(NSArray<AquisitoCoreKmpFile *> *)images __attribute__((swift_name("doCopy(food_rating:service_rating:ambience_rating:price_rating:comment:images:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSArray<AquisitoCoreKmpFile *> *images __attribute__((swift_name("images")));
