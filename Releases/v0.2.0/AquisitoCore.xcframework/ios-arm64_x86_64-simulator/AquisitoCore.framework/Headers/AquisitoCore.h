...
- (instancetype)initWithLocationClient:(id<AquisitoCoreLocationClient>)locationClient repository:(id<AquisitoCoreLocationRepository>)repository matchRadiusMeters:(double)matchRadiusMeters __attribute__((swift_name("init(locationClient:repository:matchRadiusMeters:)"))) __attribute__((objc_designated_initializer));
