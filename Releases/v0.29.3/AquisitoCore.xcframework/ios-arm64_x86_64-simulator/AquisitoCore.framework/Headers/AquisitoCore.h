...
- (instancetype)initWithAccess_token:(NSString * _Nullable)access_token avatar:(NSString * _Nullable)avatar email:(NSString * _Nullable)email name:(NSString * _Nullable)name social_id:(NSString * _Nullable)social_id __attribute__((swift_name("init(access_token:avatar:email:name:social_id:)"))) __attribute__((objc_designated_initializer));
...
- (AquisitoCoreSocialLoginDataDto *)doCopyAccess_token:(NSString * _Nullable)access_token avatar:(NSString * _Nullable)avatar email:(NSString * _Nullable)email name:(NSString * _Nullable)name social_id:(NSString * _Nullable)social_id __attribute__((swift_name("doCopy(access_token:avatar:email:name:social_id:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithAccessToken:(NSString *)accessToken message:(NSString *)message avatar:(NSString * _Nullable)avatar email:(NSString * _Nullable)email name:(NSString * _Nullable)name socialId:(NSString * _Nullable)socialId isRegistered:(BOOL)isRegistered __attribute__((swift_name("init(accessToken:message:avatar:email:name:socialId:isRegistered:)"))) __attribute__((objc_designated_initializer));
- (AquisitoCoreSocialLoginResult *)doCopyAccessToken:(NSString *)accessToken message:(NSString *)message avatar:(NSString * _Nullable)avatar email:(NSString * _Nullable)email name:(NSString * _Nullable)name socialId:(NSString * _Nullable)socialId isRegistered:(BOOL)isRegistered __attribute__((swift_name("doCopy(accessToken:message:avatar:email:name:socialId:isRegistered:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *accessToken __attribute__((swift_name("accessToken")));
