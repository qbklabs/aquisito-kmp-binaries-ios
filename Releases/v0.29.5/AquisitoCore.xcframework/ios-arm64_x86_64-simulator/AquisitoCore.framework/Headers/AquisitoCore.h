...
+ (void)Skie_Suspend__100__readRemainingDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver limit:(int64_t)limit suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__100__readRemaining(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__101__readShortDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__101__readShort(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__102__readSuspendableSessionDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver consumer:(id<AquisitoCoreKotlinSuspendFunction1>)consumer suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__102__readSuspendableSession(dispatchReceiver:consumer:suspendHandler:)")));
+ (void)Skie_Suspend__103__readUTF8LineDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver limit:(int32_t)limit suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__103__readUTF8Line(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__104__readUTF8LineToDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver out:(id<AquisitoCoreKotlinAppendable>)out limit:(int32_t)limit suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__104__readUTF8LineTo(dispatchReceiver:out:limit:suspendHandler:)")));
+ (void)Skie_Suspend__105__invokeDispatchReceiver:(id<AquisitoCoreKotlinSuspendFunction1>)dispatchReceiver p1:(id _Nullable)p1 suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__105__invoke(dispatchReceiver:p1:suspendHandler:)")));
+ (void)Skie_Suspend__106__clearCollectionsDispatchReceiver:(id<AquisitoCoreCollectionDao>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__106__clearCollections(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__107__insertCollectionsDispatchReceiver:(id<AquisitoCoreCollectionDao>)dispatchReceiver collections:(NSArray<AquisitoCoreCollectionEntity *> *)collections suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__107__insertCollections(dispatchReceiver:collections:suspendHandler:)")));
+ (void)Skie_Suspend__108__refreshDispatchReceiver:(AquisitoCoreRoom_runtimeInvalidationTracker *)dispatchReceiver tables:(AquisitoCoreKotlinArray<NSString *> *)tables suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__108__refresh(dispatchReceiver:tables:suspendHandler:)")));
+ (void)Skie_Suspend__109__clearAccessTokenDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__109__clearAccessToken(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__110__clearUserDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__110__clearUser(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__111__getAccessTokenDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__111__getAccessToken(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__112__getUserDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__112__getUser(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__113__saveAccessTokenDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver token:(NSString *)token suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__113__saveAccessToken(dispatchReceiver:token:suspendHandler:)")));
+ (void)Skie_Suspend__114__saveUserDispatchReceiver:(id<AquisitoCoreAuthLocalDataSource>)dispatchReceiver userJson:(NSString *)userJson suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__114__saveUser(dispatchReceiver:userJson:suspendHandler:)")));
+ (void)Skie_Suspend__115__clearDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__115__clear(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__116__getBooleanDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver key:(NSString *)key defaultValue:(BOOL)defaultValue suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__116__getBoolean(dispatchReceiver:key:defaultValue:suspendHandler:)")));
+ (void)Skie_Suspend__117__getStringDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver key:(NSString *)key suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__117__getString(dispatchReceiver:key:suspendHandler:)")));
+ (void)Skie_Suspend__118__putBooleanDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver key:(NSString *)key value:(BOOL)value suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__118__putBoolean(dispatchReceiver:key:value:suspendHandler:)")));
+ (void)Skie_Suspend__119__putStringDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver key:(NSString *)key value:(NSString *)value suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__119__putString(dispatchReceiver:key:value:suspendHandler:)")));
...
+ (void)Skie_Suspend__120__removeDispatchReceiver:(id<AquisitoCoreKeyValueStorage>)dispatchReceiver key:(NSString *)key suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__120__remove(dispatchReceiver:key:suspendHandler:)")));
+ (void)Skie_Suspend__121__clearSelectedDispatchReceiver:(id<AquisitoCoreLocationStorage>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__121__clearSelected(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__122__getSelectedDistrictDispatchReceiver:(id<AquisitoCoreLocationStorage>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__122__getSelectedDistrict(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__123__setSelectedDispatchReceiver:(id<AquisitoCoreLocationStorage>)dispatchReceiver district:(AquisitoCoreDistrict *)district suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__123__setSelected(dispatchReceiver:district:suspendHandler:)")));
+ (void)Skie_Suspend__124__getAvailableAreaByLocationDispatchReceiver:(AquisitoCoreAreaApi *)dispatchReceiver request:(AquisitoCoreLatLongRequest *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__124__getAvailableAreaByLocation(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__125__getAvailableAreasDispatchReceiver:(AquisitoCoreAreaApi *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__125__getAvailableAreas(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__126__deleteAccountDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__126__deleteAccount(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__127__forgotPasswordDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreForgotPasswordRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__127__forgotPassword(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__128__loginDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreLoginRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__128__login(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__129__loginSocialDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreSocialLoginRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__129__loginSocial(dispatchReceiver:request:suspendHandler:)")));
...
+ (void)Skie_Suspend__130__logoutDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__130__logout(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__131__resetPasswordDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreResetPasswordRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__131__resetPassword(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__132__signUpDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreSignUpRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__132__signUp(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__133__updatePasswordDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreUpdatePasswordRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__133__updatePassword(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__134__verifyCodeDispatchReceiver:(AquisitoCoreAuthApi *)dispatchReceiver request:(AquisitoCoreVerifyCodeRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__134__verifyCode(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__135__getCartDetailDispatchReceiver:(AquisitoCoreCartApi *)dispatchReceiver slug:(NSString *)slug id:(int32_t)id suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__135__getCartDetail(dispatchReceiver:slug:id:suspendHandler:)")));
+ (void)Skie_Suspend__136__addPlaceToCollectionDispatchReceiver:(AquisitoCoreCollectionApi *)dispatchReceiver collectionSlug:(NSString *)collectionSlug placeId:(int32_t)placeId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__136__addPlaceToCollection(dispatchReceiver:collectionSlug:placeId:suspendHandler:)")));
+ (void)Skie_Suspend__137__createCollectionDispatchReceiver:(AquisitoCoreCollectionApi *)dispatchReceiver request:(AquisitoCoreCreateCollectionRequestDto *)request suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__137__createCollection(dispatchReceiver:request:suspendHandler:)")));
+ (void)Skie_Suspend__138__getCollectionDispatchReceiver:(AquisitoCoreCollectionApi *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__138__getCollection(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__139__removeCollectionDispatchReceiver:(AquisitoCoreCollectionApi *)dispatchReceiver collectionSlug:(NSString *)collectionSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__139__removeCollection(dispatchReceiver:collectionSlug:suspendHandler:)")));
...
+ (void)Skie_Suspend__140__removePlaceFromCollectionDispatchReceiver:(AquisitoCoreCollectionApi *)dispatchReceiver collectionSlug:(NSString *)collectionSlug placeSlug:(NSString *)placeSlug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__140__removePlaceFromCollection(dispatchReceiver:collectionSlug:placeSlug:suspendHandler:)")));
+ (void)Skie_Suspend__141__parseErrorDispatchReceiver:(AquisitoCoreErrorHandler *)dispatchReceiver exception:(AquisitoCoreKotlinException *)exception suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__141__parseError(dispatchReceiver:exception:suspendHandler:)")));
+ (void)Skie_Suspend__142__getPlaceDetailDispatchReceiver:(AquisitoCorePlaceApi *)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__142__getPlaceDetail(dispatchReceiver:slug:suspendHandler:)")));
+ (void)Skie_Suspend__143__getPlacesDispatchReceiver:(AquisitoCorePlaceApi *)dispatchReceiver query:(NSDictionary<NSString *, NSString *> *)query suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__143__getPlaces(dispatchReceiver:query:suspendHandler:)")));
+ (void)Skie_Suspend__144__getListRatingDispatchReceiver:(AquisitoCoreRatingPlaceApi *)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__144__getListRating(dispatchReceiver:slug:suspendHandler:)")));
+ (void)Skie_Suspend__145__reactToRatingDispatchReceiver:(AquisitoCoreRatingPlaceApi *)dispatchReceiver ratingId:(int32_t)ratingId reactionType:(NSString *)reactionType suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__145__reactToRating(dispatchReceiver:ratingId:reactionType:suspendHandler:)")));
+ (void)Skie_Suspend__146__removeReactionDispatchReceiver:(AquisitoCoreRatingPlaceApi *)dispatchReceiver ratingId:(int32_t)ratingId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__146__removeReaction(dispatchReceiver:ratingId:suspendHandler:)")));
+ (void)Skie_Suspend__147__upsertRatingDispatchReceiver:(AquisitoCoreRatingPlaceApi *)dispatchReceiver slug:(NSString *)slug overallRating:(int32_t)overallRating foodRating:(AquisitoCoreInt * _Nullable)foodRating serviceRating:(AquisitoCoreInt * _Nullable)serviceRating ambienceRating:(AquisitoCoreInt * _Nullable)ambienceRating priceRating:(AquisitoCoreInt * _Nullable)priceRating comment:(NSString * _Nullable)comment images:(NSArray<AquisitoCoreKmpFile *> *)images suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__147__upsertRating(dispatchReceiver:slug:overallRating:foodRating:serviceRating:ambienceRating:priceRating:comment:images:suspendHandler:)")));
+ (void)Skie_Suspend__148__upgradeDispatchReceiver:(AquisitoCoreKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<AquisitoCoreKtor_ioByteReadChannel>)input output:(id<AquisitoCoreKtor_ioByteWriteChannel>)output engineContext:(id<AquisitoCoreKotlinCoroutineContext>)engineContext userContext:(id<AquisitoCoreKotlinCoroutineContext>)userContext suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__148__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__149__awaitFreeSpaceDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__149__awaitFreeSpace(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__150__writeAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(AquisitoCoreKtor_ioChunkBuffer *)src suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__150__writeAvailable(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__151__writeAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(AquisitoCoreKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__151__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__152__writeAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__152__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__153__writeAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__153__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__154__writeByteDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver b:(int8_t)b suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__154__writeByte(dispatchReceiver:b:suspendHandler:)")));
+ (void)Skie_Suspend__155__writeDoubleDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver d:(double)d suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__155__writeDouble(dispatchReceiver:d:suspendHandler:)")));
+ (void)Skie_Suspend__156__writeFloatDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver f:(float)f suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__156__writeFloat(dispatchReceiver:f:suspendHandler:)")));
+ (void)Skie_Suspend__157__writeFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver memory:(AquisitoCoreKtor_ioMemory *)memory startIndex:(int32_t)startIndex endIndex:(int32_t)endIndex suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__157__writeFully(dispatchReceiver:memory:startIndex:endIndex:suspendHandler:)")));
+ (void)Skie_Suspend__158__writeFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(AquisitoCoreKtor_ioBuffer *)src suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__158__writeFully(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__159__writeFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(AquisitoCoreKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__159__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
...
+ (void)Skie_Suspend__160__writeFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__160__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__161__writeFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__161__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__162__writeIntDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver i:(int32_t)i suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__162__writeInt(dispatchReceiver:i:suspendHandler:)")));
+ (void)Skie_Suspend__163__writeLongDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver l:(int64_t)l suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__163__writeLong(dispatchReceiver:l:suspendHandler:)")));
+ (void)Skie_Suspend__164__writePacketDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver packet:(AquisitoCoreKtor_ioByteReadPacket *)packet suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__164__writePacket(dispatchReceiver:packet:suspendHandler:)")));
+ (void)Skie_Suspend__165__writeShortDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver s:(int16_t)s suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__165__writeShort(dispatchReceiver:s:suspendHandler:)")));
+ (void)Skie_Suspend__166__writeSuspendSessionDispatchReceiver:(id<AquisitoCoreKtor_ioByteWriteChannel>)dispatchReceiver visitor:(id<AquisitoCoreKotlinSuspendFunction1>)visitor suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__166__writeSuspendSession(dispatchReceiver:visitor:suspendHandler:)")));
+ (void)Skie_Suspend__167__writeToDispatchReceiver:(AquisitoCoreKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<AquisitoCoreKtor_ioByteWriteChannel>)channel suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__167__writeTo(dispatchReceiver:channel:suspendHandler:)")));
...
+ (void)Skie_Suspend__44__invokeDispatchReceiver:(AquisitoCoreReactRatingUseCase *)dispatchReceiver ratingId:(int32_t)ratingId reactionType:(AquisitoCoreReactionType *)reactionType suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__44__invoke(dispatchReceiver:ratingId:reactionType:suspendHandler:)")));
+ (void)Skie_Suspend__45__invokeDispatchReceiver:(AquisitoCoreMarkOnboardingCompletedUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__45__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__46__hasCompletedOnboardingDispatchReceiver:(id<AquisitoCoreOnboardingRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__46__hasCompletedOnboarding(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__47__markOnboardingCompletedDispatchReceiver:(id<AquisitoCoreOnboardingRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__markOnboardingCompleted(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__48__resetOnboardingDispatchReceiver:(id<AquisitoCoreOnboardingRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__48__resetOnboarding(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__49__invokeDispatchReceiver:(AquisitoCoreLogoutUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__49__invoke(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__50__invokeDispatchReceiver:(AquisitoCoreLoginUseCase *)dispatchReceiver email:(NSString *)email password:(NSString *)password suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__invoke(dispatchReceiver:email:password:suspendHandler:)")));
+ (void)Skie_Suspend__51__clearAllDispatchReceiver:(AquisitoCoreLocationContext *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__clearAll(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__52__clearDistrictDispatchReceiver:(AquisitoCoreLocationContext *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__clearDistrict(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__53__setDistrictDispatchReceiver:(AquisitoCoreLocationContext *)dispatchReceiver district:(AquisitoCoreDistrict *)district suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__setDistrict(dispatchReceiver:district:suspendHandler:)")));
+ (void)Skie_Suspend__54__invokeDispatchReceiver:(AquisitoCoreGetListRatingsUseCase *)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__invoke(dispatchReceiver:slug:suspendHandler:)")));
+ (void)Skie_Suspend__55__invokeDispatchReceiver:(AquisitoCoreGetUserDataUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__56__invokeDispatchReceiver:(AquisitoCoreGetPlacesUseCase *)dispatchReceiver query:(NSDictionary<NSString *, NSString *> *)query suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__invoke(dispatchReceiver:query:suspendHandler:)")));
+ (void)Skie_Suspend__57__getPlaceDetailDispatchReceiver:(id<AquisitoCorePlaceRepository>)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__57__getPlaceDetail(dispatchReceiver:slug:suspendHandler:)")));
+ (void)Skie_Suspend__58__getPlacesDispatchReceiver:(id<AquisitoCorePlaceRepository>)dispatchReceiver query:(NSDictionary<NSString *, NSString *> *)query suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__58__getPlaces(dispatchReceiver:query:suspendHandler:)")));
+ (void)Skie_Suspend__59__invokeDispatchReceiver:(AquisitoCoreGetPlaceDetailUseCase *)dispatchReceiver slug:(NSString *)slug suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__59__invoke(dispatchReceiver:slug:suspendHandler:)")));
...
+ (void)Skie_Suspend__60__invokeDispatchReceiver:(AquisitoCoreGetOnboardingStatusUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__60__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__61__invokeDispatchReceiver:(AquisitoCoreGetUserDataOnContextUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__61__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__62__invokeDispatchReceiver:(AquisitoCoreGetCartDetailUseCase *)dispatchReceiver slug:(NSString *)slug id:(int32_t)id suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__62__invoke(dispatchReceiver:slug:id:suspendHandler:)")));
+ (void)Skie_Suspend__63__getCartDetailDispatchReceiver:(id<AquisitoCoreCartRepository>)dispatchReceiver slug:(NSString *)slug id:(int32_t)id suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__63__getCartDetail(dispatchReceiver:slug:id:suspendHandler:)")));
+ (void)Skie_Suspend__64__invokeDispatchReceiver:(AquisitoCoreGetAvailableAreaByLocationUseCase *)dispatchReceiver latitude:(double)latitude longitude:(double)longitude suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__64__invoke(dispatchReceiver:latitude:longitude:suspendHandler:)")));
+ (void)Skie_Suspend__65__getAvailableAreaByLocationDispatchReceiver:(id<AquisitoCoreAreaRepository>)dispatchReceiver latitude:(double)latitude longitude:(double)longitude suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__65__getAvailableAreaByLocation(dispatchReceiver:latitude:longitude:suspendHandler:)")));
+ (void)Skie_Suspend__66__getAvailableAreasDispatchReceiver:(id<AquisitoCoreAreaRepository>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__66__getAvailableAreas(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__67__invokeDispatchReceiver:(AquisitoCoreForgotPasswordUseCase *)dispatchReceiver email:(NSString *)email suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__67__invoke(dispatchReceiver:email:suspendHandler:)")));
+ (void)Skie_Suspend__68__invokeDispatchReceiver:(AquisitoCoreEnsureSetLocationUserUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__68__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__69__getApproxLocationDispatchReceiver:(id<AquisitoCoreLocationClient>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__69__getApproxLocation(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__70__invokeDispatchReceiver:(AquisitoCoreDeleteAccountUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__70__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__71__invokeDispatchReceiver:(AquisitoCoreCreateCollectionUseCase *)dispatchReceiver name:(NSString *)name description:(NSString * _Nullable)description type:(NSString *)type isPublic:(BOOL)isPublic trackChanges:(BOOL)trackChanges suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__71__invoke(dispatchReceiver:name:description:type:isPublic:trackChanges:suspendHandler:)")));
+ (void)Skie_Suspend__72__invokeDispatchReceiver:(AquisitoCoreCheckUserLocationUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__72__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__73__invokeDispatchReceiver:(AquisitoCoreGetAvailableAreasUseCase *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__73__invoke(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__74__invokeDispatchReceiver:(AquisitoCoreAddPlaceToCollectionUseCase *)dispatchReceiver collectionSlug:(NSString *)collectionSlug placeId:(int32_t)placeId suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__74__invoke(dispatchReceiver:collectionSlug:placeId:suspendHandler:)")));
+ (void)Skie_Suspend__75__executeDispatchReceiver:(id<AquisitoCoreKtor_client_coreHttpClientEngine>)dispatchReceiver data:(AquisitoCoreKtor_client_coreHttpRequestData *)data suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__75__execute(dispatchReceiver:data:suspendHandler:)")));
+ (void)Skie_Suspend__76__joinDispatchReceiver:(id<AquisitoCoreKotlinx_coroutines_coreJob>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__76__join(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__77__executeDispatchReceiver:(AquisitoCoreKtor_utilsPipeline<id, id> *)dispatchReceiver context:(id)context subject:(id)subject suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__77__execute(dispatchReceiver:context:subject:suspendHandler:)")));
+ (void)Skie_Suspend__78__invokeDispatchReceiver:(id<AquisitoCoreKotlinSuspendFunction2>)dispatchReceiver p1:(id _Nullable)p1 p2:(id _Nullable)p2 suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__78__invoke(dispatchReceiver:p1:p2:suspendHandler:)")));
+ (void)Skie_Suspend__79__bodyDispatchReceiver:(AquisitoCoreKtor_client_coreHttpClientCall *)dispatchReceiver info:(AquisitoCoreKtor_utilsTypeInfo *)info suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__79__body(dispatchReceiver:info:suspendHandler:)")));
...
+ (void)Skie_Suspend__80__bodyNullableDispatchReceiver:(AquisitoCoreKtor_client_coreHttpClientCall *)dispatchReceiver info:(AquisitoCoreKtor_utilsTypeInfo *)info suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__80__bodyNullable(dispatchReceiver:info:suspendHandler:)")));

/**
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
+ (void)Skie_Suspend__81__getResponseContentDispatchReceiver:(AquisitoCoreKtor_client_coreHttpClientCall *)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__81__getResponseContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__82__awaitContentDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__82__awaitContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__83__discardDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver max:(int64_t)max suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__83__discard(dispatchReceiver:max:suspendHandler:)")));
+ (void)Skie_Suspend__84__peekToDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver destination:(AquisitoCoreKtor_ioMemory *)destination destinationOffset:(int64_t)destinationOffset offset:(int64_t)offset min:(int64_t)min max:(int64_t)max suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__84__peekTo(dispatchReceiver:destination:destinationOffset:offset:min:max:suspendHandler:)")));
+ (void)Skie_Suspend__85__readAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(AquisitoCoreKtor_ioChunkBuffer *)dst suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__85__readAvailable(dispatchReceiver:dst:suspendHandler:)")));
+ (void)Skie_Suspend__86__readAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(AquisitoCoreKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__86__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__87__readAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__87__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__88__readAvailableDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int64_t)offset length:(int64_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__88__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__89__readBooleanDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__89__readBoolean(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__90__readByteDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__90__readByte(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__91__readDoubleDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__91__readDouble(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__92__readFloatDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__92__readFloat(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__93__readFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(AquisitoCoreKtor_ioChunkBuffer *)dst n:(int32_t)n suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__93__readFully(dispatchReceiver:dst:n:suspendHandler:)")));
+ (void)Skie_Suspend__94__readFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(AquisitoCoreKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__94__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__95__readFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__95__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__96__readFullyDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int64_t)offset length:(int64_t)length suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__96__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__97__readIntDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__97__readInt(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__98__readLongDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__98__readLong(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__99__readPacketDispatchReceiver:(id<AquisitoCoreKtor_ioByteReadChannel>)dispatchReceiver size:(int32_t)size suspendHandler:(AquisitoCoreSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__99__readPacket(dispatchReceiver:size:suspendHandler:)")));
